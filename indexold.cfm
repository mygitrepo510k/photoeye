<cfset xBookaWeek="#application.bookoftheweek#">  
...
<cfswitch expression = "#HTTP_HOST#">
   <cfcase value = "www.artphotoindex.com">
      <cflocation url="http://www.photoeye.com/api/" addToken="no"> 
      <cfabort>
   </cfcase>
    <cfcase value = "http://artphotoindex.com">
      <cflocation url="http://www.photoeye.com/api/" addToken="no">
      <cfabort>
   </cfcase>
</cfswitch>
...
<!--- The other setting to uncomment is in global/includes/dsp_footer.cfm --->
<cfset xHoliday = 0>
...
<cfswitch expression = "#HTTP_HOST#">
   <cfcase value = "www.internationalphotographerindex.com">
      <cflocation url="www.photoeye.com/api/" addToken="no">
      <cfabort>
   </cfcase>  
...
<CFIF IsDefined("HTTP_HOST")>
	<cfswitch expression = "#HTTP_HOST#">
	   <cfcase value = "www.photo-eye.com">
	      <cflocation url="http://www.photoeye.com" addToken="no">
	   </cfcase>
    <cfcase value = "www.penttisammallahti.com">
      <cflocation url="http://www.photoeye.com/gallery/forms2/homepage.cfm?id=68149&image=1&imagePosition=1&Door=2&Portfolio=Portfolio1&Gallery=2" addToken="no">
   </cfcase>
	</cfswitch>
</CFIF>
<!---
...
<CFQUERY NAME="qGetPortfolio" DATASOURCE="photoeyecom">
	...
	WHERE (P.ImgQty > 0)and (I.ShowcaseOK = 1) and i.notavailable <> 4 AND (P.ShowcaseOK = 1) and I.ImagePosition > 0 
...
<CFQUERY NAME="qGetPhoto" DATASOURCE="photoeyecom">
	SELECT DISTINCT 
	TOP 1 G.Subdirectory AS SubDirectory, G.FirstName AS Firstname, P.ImgQty AS ImageQTy, G.LastName AS Lastname, G.Gallery AS Gallery, G.Custnumber AS Custnumber, P.SubDirectory AS Portfolio, CONVERT(char(20), P.ExhibitionOpened, 102) AS Opened, I.ImageNumber AS Imagenumber, I.ShowcaseOK, I.ImagePosition AS IMAGEPOSITION, D.PortfolioName as xPortfolio, I.Title as Title, NewID() as RandomOrder
	FROM GallerySetup G 
	INNER JOIN GalleryPortfolio P ON G.Custnumber = P.Custnumber 
...
<CFSET xLastName = qGetPhoto.Lastname>
	...
	<cfif CGI.X_FORWARDED_FOR is '65.100.24.36'><cfoutput> </cfoutput></cfif>
...
<cfif xrecordfound is 1>
		...
		<!--- onmouseout="swapbglogo('back')" --->
				<a href="gallery/" onmouseover="swapbglogo('gallery')"<!--- onmouseout="swapbglogo('back')" --->>
	...
	<!--- Auctions --->
		...
		<div class="Home_Division" id="visualserver">
			<!--- onmouseout="swapbglogo('back')" --->>
				...
				<img src="images/julieblackmon.jpg" alt="JulieBlackmon.com" width="150" height="97"/ > <!--- home_visualserver.jpg" --->
			</a>
		</div>
			<!--- Guide --->
		...
		<div class="Home_Division" id="magazine">
			<!--- onmouseout="swapbglogo('back')" --->>
				<a href="http://www.photoeye.com/magazine/" onmouseover="swapbglogo('magazine')"<!--- onmouseout="swapbglogo('back')" --->>
...
<!---
				...
				<img src="images/mg_review.jpg" width="#mg_info.width#" height="#mg_info.height#"/>
--->


				<img src="images/mg_best2012.jpg" width="180" height="84" /> 

				
				<!---  width="#mg_info.width#" height="#mg_info.height#" --->
			</a>
		</div>
...
<div class="TodaysBS_Tip" id="visualserver_TT"><a href="visualserver/" style="color:white;">
			A complete website solution for easy creation and management of online portfolios. Website Example: julieblackmon.com
			</a>
</div>
