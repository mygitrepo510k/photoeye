...
<body style="font-family:verdana, helvetica, arial, sans-serif;margin:0;padding:0;">
<h1 style="background:##B82619;padding:.3em;margin:0;font-style:italic;">Lighthouse <span style="color:##fff;">Pro</span> Notification</h1>
<dl style="border-top:15px solid ##000;padding:1em;background:##E6DFCF;overflow:auto;margin:0;">
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Project:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#project.getname()#</dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Issue:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#issueBean.getPublicID()#) #issueBean.getName()# <cfif isDefined("arguments.oldBean") and issueBean.getName() neq arguments.oldBean.getName()> (was #arguments.oldBean.getName()#)</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Project Area:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><cfif isObject(locus)>#locus.getName()#<cfelse>#locus#</cfif> <cfif isObject(oldLocus) and isObject(locus) and locus.getName() neq oldLocus.getName()> (was #oldLocus.getName()#)</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Description:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#helpers.udfs.paragraphFormat2(htmlEditFormat(issueBean.getDescription()))#</dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">History:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;color: blue;">#helpers.udfs.paragraphFormat2(htmlEditFormat(issueBean.getHistory()))#</dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Link:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><a href="#link#">Log into Lighthouse to update issue</a></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Milestone:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><cfif len(issueBean.getMilestoneIDFK())>#milestone#</cfif> <cfif isDefined("arguments.oldBean") and milestone neq oldmilestone and oldmilestone neq ""> (was #oldmilestone#)</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Severity:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#severity# <cfif isDefined("arguments.oldBean") and severity neq oldseverity and oldseverity neq ""> (was #oldseverity#)</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Status:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#status# <cfif isDefined("arguments.oldBean") and status neq oldstatus and oldstatus neq ""> (was #oldstatus#)</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Due Date:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><cfif len(issueBean.getDueDate())>#dateFormat(issueBean.getDueDate(), "m/d/yy")#</cfif><cfif isDefined("arguments.oldBean") and len(oldduedate)> was #dateFormat(oldduedate, "m/d/yy")#</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Type:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#issuetype# <cfif isDefined("arguments.oldBean") and issuetype neq oldissuetype and oldissuetype neq ""> (was #oldissuetype#)</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Related URL:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><cfif len(issueBean.getRelatedURL())><a href="#issueBean.getRelatedURL()#">#issueBean.getRelatedURL()#</a></cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Creator:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><cfif isObject(creator) and len(creator.getName())>#creator.getName()#</cfif></dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Created:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#dateFormat(issueBean.getCreated(),"m/d/yy")# #timeFormat(issueBean.getCreated(),"h:mm tt")#</dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Updated:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;">#dateFormat(issueBean.getUpdated(),"m/d/yy")# #timeFormat(issueBean.getUpdated(),"h:mm tt")#</dd>
	<br /><br />
	<dt style="clear:left;width:15%;font-weight:bold;text-align:right;padding-right:.5em;float:left;margin:.5em 0 0 0;font-size:small;">Owner:</dt>
	<dt style="width:80%;float:left;margin:.5em 0 0 0;font-size:small;"><cfif isObject(user)>#user.getName()# <cfif isObject(oldUser) and user.getName() neq oldUser.getName()> (was #oldUser.getName()#)</cfif></cfif></dd>
</dl>	

<p class="footnote" style="clear:both; margin:0;font-size:small;padding:.5em;">This email was generated by Lighthouse Pro, an open-source ColdFusion bug tracker application created by Raymond Camden. Find more information at the Lighthouse Pro web site: <a href="http://lighthousepro.riaforge.org">http://lighthousepro.riaforge.org</a></p>
</body>
</html>
</cfoutput>
</cfsavecontent>
