...
<!--- Start main image display area --->
	...
	<!--- 	<div id="sivDisplay" style="width:602px;margin-top:30px;">	 --->
		<div id="sivDisplay" style="width:100%;margin-top:30px;">					
			<div id="sivImage">
...
<!--- 					<span style="display:none;"><cfoutput>#qImage.sequence-2#</cfoutput></span> --->
			...
			<!---		<cfmodule template="../../Includes/act_Image_Display.cfm" 
				...
				<cfoutput>	<img src="http://www.visualserver.com/artists/#qShowcaseArtist.subdirectory#/#qShowcasePortfolio.subdirectory#/Images_Large/Image#qShowcaseGalleryIndividualPhotos.ImageNUMBER#_h600xw900.jpg"  /></cfoutput> <!--- height="#imageinfo.height#"--->
