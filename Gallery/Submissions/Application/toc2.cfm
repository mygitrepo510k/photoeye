...
<html>
<head>
<title>photo-eye Project/Portfolio Submissions | Application Form </title>
...
<body bgcolor="#000000" text="#CCCCCC" leftmargin="5" topmargin="10" link="#FFFFCC" vlink="#99FF99" alink="#CC0000">
 ...
 <br><br><br><br><br><br>
<!--- <img src="/images/photoeye_logo_magazine.png" width="196" height="100">---></font>
...
<!--- <a href="../../../templates/AddtoCartPSApply.cfm?PSApply=1">Apply&nbsp;Online</a> ---> <!--- ShowcaseDoor=1 --->
 ...
 <cfelse> --->
  ...
  <tr> 
    <td width="36"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="12"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">6</font></td>
    <td width="947"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="UploadImages.cfm?id=<cfoutput>#URL.ID#</cfoutput>">Upload&nbsp;JPGs</a> 
      </font></td>
  </tr>
  <tr> 
    <td width="36">&nbsp;</td>
