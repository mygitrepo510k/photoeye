...
<form method=post enctype="text/plain" action="Bio.cfm?id=<cfoutput>#URL.ID#</cfoutput>"><div align="center">
      ...
      <tr><td align="center">
          ...
          <table width="95%" border="0" cellpadding="5" bgcolor="#FFFFFF" cellspacing="0" valign="top" align="center">
            <tr valign="top"> 
              <td colspan="3" align="left"><img src="../SharedImages/photo-eye%20Explore%20NewLogo_photoShowcaseVersionWhiteBackground.jpg" width="151" height="94">
</td>
            </tr>
			<TR>
			    ...
			    <TD COLSPAN="3" ALIGN="LEFT"><font face="Verdana,Arial,Helvetica,sans-serif" size="4">Overview</font><font face="Verdana,Arial,Helvetica,sans-serif" size="5"> 
                  <br>
                  <font size="2">Welcome to the Photographer's Showcase Online Application<br>
                  <br>
              ...
              <td align="center" height="420"> 
                <div align="left"> 
                  ...
                  <p align="left"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="Black"> 
                    ...
                    <font color="Red">online only</font> using the following application 
                    process.</b><br>
                    </font> <br>
                  ...
                  about any formatting changes. At this point, <b>photo-eye</b> 
                  is only interested in the information.<br>
                  </font> <br>
                  <hr size="1" noshade color="black">
                  <br>
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="2" Color="black"> 
                  ...
                  At this point, <b>photo-eye</b> is only interested in the information. 
                  <br>
                  </font> <br>
                  <hr size="1" noshade color="black">
                  <br>
                  ...
                  <b>photo-eye</b> is only interested in the information.<br>
                  </font> <br>
                  <hr size="1" noshade color="black">
                  <br>
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="2" Color="black"> 
                  ...
                  will resize them based on Showcase requirements. There may be 
                  ...
                  72 dpi (dots per inch). Each file should average between 100k 
                  to 200k in size. <br>
                  <br>
