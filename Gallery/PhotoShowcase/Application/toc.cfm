...
<table width="100%" border="0">
  ...
  <tr> 
    <td colspan="3"><font face="Verdana,Arial,Helvetica,sans-serif" size="2" color="#FFFFFF"><a href = "Overview1.html">Overview</a></font></td>
  </tr>
  <tr> 
    <td width="36">&nbsp;</td>
    <td width="12">&nbsp;</td>
...
<!--- <a href="../../../templates/AddtoCartPSApply.cfm?PSApply=1">Apply&nbsp;Online</a> ---> <!--- ShowcaseDoor=1 --->
 ...
 <cfelse>
  ...
  <tr> 
    <td width="36"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="12"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">2</font></td>
    <td width="947"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="Bio.cfm?custnumber=<cfoutput>#URL.ID#</cfoutput>">Optional&nbsp;Bio</a> 
      </font></td>
  </tr>
   <tr> 
    <td width="36">&nbsp;</td>
  ...
  <tr> 
    <td width="36"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="12"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">3</font></td>
    <td width="947"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="Statement.cfm?custnumber=<cfoutput>#URL.ID#</cfoutput>">Optional&nbsp;Statement</a> 
      </font></td>
  </tr>
  <tr> 
    <td width="36">&nbsp;</td>
  ...
  <tr> 
    <td width="36"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="12"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">4</font></td>
    <td width="947"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="Statement_P.cfm?custnumber=<cfoutput>#URL.ID#</cfoutput>">Optional&nbsp;Statement</a> 
      </font></td>
  </tr>
  <tr> 
    <td width="36">&nbsp;</td>
    ...
    <td width="36"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="12"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">5</font></td>
    <td width="947"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="TitleList.cfm?custnumber=<cfoutput>#URL.ID#</cfoutput>">Optional&nbsp;Title  List</a> 
      </font></td>
  </tr>
  <tr> 
    <td width="36">&nbsp;</td>
  ...
  <tr> 
    <td width="36"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="12"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">6</font></td>
    <td width="947"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="UploadImages.cfm?custnumber=<cfoutput>#URL.ID#</cfoutput>">Upload&nbsp;Jpegs</a> 
      </font></td>
  </tr>
  <tr> 
    <td width="36">&nbsp;</td>
