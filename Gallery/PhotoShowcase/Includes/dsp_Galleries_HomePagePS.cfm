...
<cfset ImageNumber = 1>
<CFSET xTitle="P h o t o g r a p h e r ' s    S h o w c a s e">
<CFSET xPathToRoot="../../">
...
<br />
<CFSET xSubtitle = "o p e n i n g    t h i s    w e e k">
<cfinclude template="../../../templates/title.cfm">
<DIV ALIGN="CENTER">
<CFOUTPUT>
...
WHERE   G.Custnumber = P.Custnumber and G.Custnumber = D.Custnumber AND P.Subdirectory = D.Subdirectory AND P.ImgQty>0 AND G.Gallery='PhotoShowcase' and P.ShowcaseOK=1  AND (I.ImagePosition = #xImgPosition#)
...
<TABLE CELLPADDING="0" CELLSPACING="0" BGCOLOR="##FFFFFF" BORDER="0" ALIGN="CENTER">
  <tr>
    <td>
     <div align="center">
      <a href="/Gallery/forms2/index.cfm?image=#qGetCurrentShow.imageNumber#&id=#qGetCurrentShow.custNumber#&imagePosition=#qGetCurrentShow.imagePosition#&Door=1&Portfolio=#qGetCurrentShow.portfolio#&Gallery=#qGetCurrentShow.gallery#">
       <img src="/artists/#qGetCurrentShow.Subdirectory#/#qGetCurrentShow.Portfolio#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#qGetCurrentShow.firstname# #qGetCurrentShow.lastname#: #qGetCurrentShow.PortfolioName#" title="#qGetCurrentShow.firstname# #qGetCurrentShow.lastname#: #qGetCurrentShow.PortfolioName#" style="border: 1px solid ##DDDDDD;">
      </a> 
       <br>
...
<BR>
<CFSET xSubtitle = "r e c e n t    s h o w c a s e    o p e n i n g s">
<cfinclude template="/templates/title.cfm">
<DIV id="HopePagePE_Container" ALIGN="CENTER">
...
WHERE  P.ImgQty>0 AND G.Gallery='PhotoShowcase' and I.ImagePosition=1 and G.Tier=1 and P.ShowcaseOK=1 
ORDER BY P.EXHIBITIONOPENED DESC
<!--- ORDER BY I.GeneralRandomNo --->
<!--- AND I.GeneralRandomNo>#imgNextBeginNo#  --->
</cfquery>

<!--- This prevents the top person's other portfolios from showing here --->
<!--- and G.custNumber<>'#qGetCurrentShow.custNumber#' --->
...
url.imgbegin = qGetNextBeginningRandomNumber.GeneralRandomNo above--->
  ...
  P.AutoID<>#ListGetAt(xAutoIDList, 8)# ORDER BY GeneralRandomNo
...
<cfoutput query="qGetShowcaseSetupInfo" startrow=1 maxrows=8>
  ...
  <td height="125" align="center"><a href="/gallery/forms2/index.cfm?image=#ImageNumber#&id=#qGetShowcaseSetupInfo.Custnumber#&imagePosition=#ImagePosition#&Door=2&Portfolio=#qGetShowcaseSetupInfo.Portfolio#&Gallery=2">
    ...
    <CFIF xPan is 2>
      ...
      <img src="/artists/#qGetShowcaseSetupInfo.Subdirectory#/#qGetShowcaseSetupInfo.Portfolio#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#qGetShowcaseSetupInfo.firstname# #qGetShowcaseSetupInfo.lastname#" title="#qGetShowcaseSetupInfo.firstname# #qGetShowcaseSetupInfo.lastname#" style="border: 1px solid ##DDDDDD;">
      <!--- End ImageSizer --->
    </CFIF>
    </a> <br>
    <img src="../SharedImages/dot_clear.gif" width="1" height="20">#Ucase(qGetShowcaseSetupInfo.Firstname)# #UCase(qGetShowcaseSetupInfo.Lastname)#</td>
...
#qGetShowcaseHighlight.email#" --->
    ...
    <font size="2" face="Arial, Helvetica, sans-serif"> We're pleased to announce that you are today's Photographer's Showcase highlight at Photoeye.com<br><br><a href="http://www.photoeye.com/gallery/PhotoShowcase/homepagePSNew.cfm" target="_blank">View it now.</a>
     <br><br> The photo-eye team</font>
    </cfmail>
  </cfloop> 
 </cfif> 
<br />

<CFSET xSubtitle = "t o d a y ' s    s h o w c a s e    h i g h l i g h t">
<cfinclude template="/templates/title.cfm">
<CFOUTPUT>
...
#xRelativePath#\Artists\#qGetShowcaseHighlight.Subdirectory#\#qGetShowcaseHighlight.Portfolio#\Images_Large\"<br />
 ...
 <td style="padding-right:25px;" align="center">
  <a href="http://www.photoeye.com/Gallery/forms2/index.cfm?image=#qGetShowcaseHighlight.imageNumber#&id=#qGetShowcaseHighlight.custNumber#&imagePosition=#qGetShowcaseHighlight.imagePosition#&Door=2&Portfolio=#qGetShowcaseHighlight.portfolio#&Gallery=2"><!--- gallery=#qGetShowcaseHighlight.gallery# --->
   <img src="/artists/#qGetShowcaseHighlight.Subdirectory#/#qGetShowcaseHighlight.Portfolio#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#qGetShowcaseHighlight.firstname# #qGetShowcaseHighlight.lastname#" title="#qGetShowcaseHighlight.firstname# #qGetShowcaseHighlight.lastname#" style="border: 1px solid ##DDDDDD;">
  </a><br>
	<cfif xdebug is 1>
...
<cfset xlengthcheck = '#qGetShowcaseHighlight.firstName# #qGetShowcaseHighlight.lastName#'>
  #qGetShowcaseHighlight.firstName# #qGetShowcaseHighlight.lastName# <cfif len(trim(xlengthcheck)) LT 21><br/><span style="color:##fff;">.</span></cfif>
 </td>
</cfloop>
</tr>
</TABLE>
...
<cfoutput query="qGetShowcaseRandom" startrow=1 maxrows=200>
  ...
  <td height="125" align="center"><a href="/gallery/forms2/index.cfm?image=#ImageNumber#&id=#qGetShowcaseRandom.Custnumber#&imagePosition=#ImagePosition#&Door=2&Portfolio=#qGetShowcaseRandom.Portfolio#&Gallery=2">
    <!--- Panorama? --->
    <CFQUERY NAME="qGetPanorama"  DATASOURCE="photoeyecom">
    SELECT Panorama
    ...
    <CFIF xPan is 2>
      ...
      <img src="/artists/#qGetShowcaseRandom.Subdirectory#/#qGetShowcaseRandom.Portfolio#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#qGetShowcaseRandom.firstname# #qGetShowcaseRandom.lastname#" title="#qGetShowcaseRandom.firstname# #qGetShowcaseRandom.lastname#" style="border: 1px solid ##DDDDDD;">
      <!--- End ImageSizer --->
    </CFIF>
    </a> <br>
    <img src="/gallery/SharedImages/dot_clear.gif" width="1" height="20">#Ucase(qGetShowcaseRandom.Firstname)# #UCase(qGetShowcaseRandom.Lastname)#</td>
...
<!--- End overall div --->
<!--- Added 01.21.09, to fix footer problem AGAIN.  There must be some f-ed code in a loop in here somewhere or something. --->
</div>
</div>