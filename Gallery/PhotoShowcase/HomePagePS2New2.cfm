...
<table width="90%" border="0" align="center"">
  ...
  <div align="center"><b>
 <img src="SharedImages/dot_clear.gif" width="1" height="1"><a href="HomePagePS1New2.cfm"><font face="verdana, arial, helvetica, sans-serif" size="1" color="Maroon" onMouseOver="this.color='Red';" onMouseOut="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase&nbsp;Represented&nbsp;Artists</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="HomePagePS3New3.cfm"><font face="verdana, arial, helvetica, sans-serif" size="1" color="Maroon" onMouseOver="this.color='Red';" onMouseOut="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase&nbsp;Independent&nbsp;Photographers</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="../qcd2449x90s18bc.html"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Galleries&nbsp;Home</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('../photoshowcaseemailNoFrame.html','Popup','600','320','no');"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Exhibit&nbsp;Your&nbsp;Work!</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('Documentation/index.cfm','Popup','600','460','no');"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase&nbsp;Information</font></a></b>
<br></div>
</td></tr></table>
  ...
  <br><DIV align="center"><b><font face="verdana, arial, helvetica, sans-serif" size="2" color="#333333">P 
	...
	<br> <font face="verdana, arial, helvetica, sans-serif" size="2" color="Navy">G A L L E R Y&nbsp;&nbsp;&nbsp;T W O &nbsp;-&nbsp; 
E M E R G I N G&nbsp;&nbsp;&nbsp;A R T I S T S</font> </b></div><hr width="400" size="1" noshade><font face="verdana, arial, helvetica, sans-serif" size="1" color="#666666"><b>
Discover Fresh and Exciting Work by Emerging Artists<br><img src="SharedImages/dot_clear.gif" width="1" height="17">These Artists' Portfolios were Accepted for Exhibition by the Photographer's Showcase <a href="javascript:popUp('../underconstruction.HTML','Popup','620','460','no');">Jury</a><br><img src="SharedImages/dot_clear.gif" width="1" height="12">photo-eye Represents these Artists Online Only</b></font><br><img src="SharedImages/dot_clear.gif" width="1" height="1">
...
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>#imgNextBeginNo#  AND G.Gallery='PhotoShowcase' and I.ImageNumber=1 and G.Tier=2
...
FROM GallerySetup G INNER JOIN
     GalleryPortfolio P ON G.Custnumber = P.Custnumber INNER JOIN
     GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>0  AND G.Gallery='PhotoShowcase' and I.ImageNumber=1 and G.Tier=2
ORDER BY I.GeneralRandomNo
</cfquery>
...
FROM GallerySetup G INNER JOIN
     GalleryPortfolio P ON G.Custnumber = P.Custnumber INNER JOIN
     GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>#imgBegin#   AND G.Gallery='PhotoShowcase' and G.Tier=2 AND I.ImageNumber=1
ORDER BY I.GeneralRandomNo 
			</cfquery>
...
<br>
<FONT color="##333333" face="verdana, arial, Helvetica, sans-serif" size="1"><b>Click Images to View Artists' Portfolios</b></font> <br><img src="SharedImages/dot_clear.gif" width="1" height="5">
<!---  <cfoutput> --->
