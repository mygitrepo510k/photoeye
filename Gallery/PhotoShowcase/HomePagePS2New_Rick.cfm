...
113 Portfolios as of 11/12/04
SELECT     COUNT(*) AS Expr1
FROM         GalleryPortfolio INNER JOIN
                      GallerySetup ON GalleryPortfolio.Custnumber = GallerySetup.Custnumber
WHERE     (GallerySetup.Gallery = 'PhotoShowcase') AND (GalleryPortfolio.ShowcaseOK = 1)
...
<cfoutput>imgBegin=#imgBegin#</cfoutput>
