...
<html>
<head>
	<title>photo-eye Photographer's Showcase |  Emerging Artists</title>
...
<table width="80%" border="0" align="center"">
  ...
  <div align="center"><b>
 <img src="SharedImages/dot_clear.gif" width="1" height="1"><a href="HomePagePS1New2.cfm"><font face="verdana, arial, helvetica, sans-serif" size="1" color="Maroon" onMouseOver="this.color='Red';" onMouseOut="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase Established Artists</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp; </font><a href="HomePagePS2New2.cfm"><font face="verdana, arial, helvetica, sans-serif" size="1" color="Maroon" onMouseOver="this.color='Red';" onMouseOut="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase Emerging Artists</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="../qcd2449x90s18bc.html"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Galleries Home</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('../photoshowcaseemailNoFrame.html','Popup','600','320','no');"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Exhibit Your Work!</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('Documentation/index.cfm','Popup','600','460','no');"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase Information</font></a></b>
<br></div>
</td></tr></table>

  <br><DIV align="center"><b><font face="verdana, arial, helvetica, sans-serif" size="2" color="#333333">P 
    H O T O G R A P H E R ' S&nbsp;&nbsp;&nbsp;&nbsp;S H O W C A S E <SUP><FONT SIZE="-1">SM</FONT></SUP></font>
	<br> <font face="verdana, arial, helvetica, sans-serif" size="2" color="Navy">G A L L E R Y&nbsp;&nbsp;&nbsp;T H R E E &nbsp;-&nbsp; 
I N D E P E N D E N T&nbsp;&nbsp;&nbsp;P H O T O G R A P H E R S</font> </b></div><hr width="400" size="1" noshade><!--- <img src="../SharedImages/Redlinetoc.gif" width="400" height="1" alt="" border="0"> <br><img src="SharedImages/dot_clear.gif" width="1" height="15"> ---><font face="verdana, arial, helvetica, sans-serif" size="1" color="#666666"><b>Photographers with Selected Images Chosen by the Photographer's Showcase <a href="javascript:popUp('../underconstruction.HTML','Popup','620','460','no');">Jury</a>
<!--- The Photographer's Showcase <a href="javascript:popUp('../underconstruction.HTML','Popup','620','460','no');">jury</a> has selected individual images by the following photographers for exhibition. ---><br><img src="SharedImages/dot_clear.gif" width="1" height="12">
Contact these Independent Photographers Directly Regarding Print Sales or Additional Information</b></font><br><img src="SharedImages/dot_clear.gif" width="1" height="1">
...
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>#imgNextBeginNo#  AND G.Gallery='PhotoShowcase' and I.ImageNumber=1 and G.Tier=3
...
FROM GallerySetup G INNER JOIN
     GalleryPortfolio P ON G.Custnumber = P.Custnumber INNER JOIN
     GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>0  AND G.Gallery='PhotoShowcase' and I.ImageNumber=1 and G.Tier=3
ORDER BY I.GeneralRandomNo
</cfquery>
...
FROM GallerySetup G INNER JOIN
     GalleryPortfolio P ON G.Custnumber = P.Custnumber INNER JOIN
     GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>#imgBegin#   AND G.Gallery='PhotoShowcase' and G.Tier=3 AND I.ImageNumber=1
ORDER BY I.GeneralRandomNo 
			</cfquery>
  ...
  <cfif counter is 11>
	...
	<cfelse>
			...
			<!--- Write Next Page Number --->
	-		 <a href="homepagePS1New3.cfm?imgbegin=#imgNextBeginNo#&Page=#counter#"><FONT color="silver" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='silver';"  style="TEXT-DECORATION: none"><b>#counter#</b></font></a>	
	</cfif> <!--- End if counter and page are the same --->
  </cfif> <!--- End if Counter is between 1 and 11 --->
...
<br>
<FONT color="##333333" face="verdana, arial, Helvetica, sans-serif" size="1"><b>Click Images to View Jury's Selected Works by Independent Photographers</b></font> <br><img src="SharedImages/dot_clear.gif" width="1" height="5">
<!---  <cfoutput> --->
...
<cfif page is 1>
	<cfset imgbeginType3=0>
<cfelse>
	<cfset imgbeginType3=#imgBegin#>
</cfif>
