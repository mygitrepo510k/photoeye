...
<table width="80%" border="0" align="center">
  ...
  <div align="center"><b>
 <img src="../SharedImages/dot_clear.gif" width="1" height="1"><!--- <a href="HomePagePS2New2.cfm"><font face="verdana, arial, helvetica, sans-serif" size="1" color="Maroon" onMouseOver="this.color='Red';" onMouseOut="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase Emerging Artists</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp; </font><a href="HomePagePS3New3.cfm"><font face="verdana, arial, helvetica, sans-serif" size="1" color="Maroon" onMouseOver="this.color='Red';" onMouseOut="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase Independent Photographers</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font>---> <a href="../index.cfm"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">All Galleries Home</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('newdocumentation/Artists/SubmissionProcess2.html','Popup','600','460');" target="_top"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Exhibit Your Work!</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('newdocumentation/artists/overviewphotographers3.html','Popup','600','460');" target="_top"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Showcase Information</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('../ShippingCosts.html','Popup','600','460');"><!--- <a href="http://www.magnumphotos.com/about.html" target="_top"> ---><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">Shipping Costs</font></a><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1">&nbsp;&nbsp;| &nbsp;</font><a href="javascript:popUp('../../templates/viewshoppingcartcontentsphotoshowcase.cfm?Showcase=2','MyWindowOrder','600','500');"><FONT color="Maroon" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='Maroon';"  style="TEXT-DECORATION: none">View Your Order</font></a></b>
<br></div>
</td></tr></table>
...
A Juried Sales and Exhibition Gallery Devoted to Serious Artists Worldwide<!---<a href="javascript:popUp('AIPAD.HTML','Popup','620','460','no');">Significant</a> Exhibition or Publication History<br><img src="../SharedImages/dot_clear.gif" width="1" height="12">photo-eye Represents these Artists Online Only ---></b></font><br><img src="../SharedImages/dot_clear.gif" width="1" height="5"><font face="verdana, arial, helvetica, sans-serif" size="1" color="#333333"><b><br><a href="SearchShowcase.cfm?Gallery=2"><font color="navy">Search</font></a> our Photographer's Showcase Directories</b></font><!--- <br><img src="../SharedImages/dot_clear.gif" width="1" height="25"> --->


<!--- <form>
 <FONT color="##333333" face="verdana, arial, Helvetica, sans-serif" size="1"><b>Include:&nbsp;<cfset include = 1>
<input type="radio" name="RadioInclude" value="1" <cfif Include is 1>checked</cfif> onClick="document.MyForm.submit();">
<A HREF="javascript:popUp('photoshowcase/RepresentedArtists.html','myWindowEnlarge',375,300);">Established</a> Artists 

&nbsp;&nbsp;<input type="radio" name="RadioInclude" value="2" <cfif Include is 2>checked</cfif> onClick="document.MyForm.submit();"> photo-eye 
<A HREF="javascript:popUp('photoshowcase/IndependentPhotographers.html','myWindowEnlarge',375,300);">Discoveries</a>

&nbsp;&nbsp;<input type="radio" name="RadioInclude" value="3" <cfif Include is 3>checked</cfif> onClick="document.MyForm.submit();">
All</b></font>
<!--- <br><img src="../SharedImages/dot_clear.gif" width="1" height="17">  --->
</form> --->
...
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>#imgNextBeginNo#  AND G.Gallery='PhotoShowcase' and I.ImageNumber=1 and G.Tier=1 and P.ShowcaseOK=1 ORDER BY P.EXHIBITIONOPENED DESC 
...
FROM GallerySetup G INNER JOIN
     GalleryPortfolio P ON G.Custnumber = P.Custnumber INNER JOIN
     GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>0  AND G.Gallery='PhotoShowcase' and I.ImageNumber=1 and G.Tier=1 and P.ShowcaseOK=1 ORDER BY P.EXHIBITIONOPENED DESC 
<!--- ORDER BY I.GeneralRandomNo --->
</cfquery>
...
FROM GallerySetup G INNER JOIN
     GalleryPortfolio P ON G.Custnumber = P.Custnumber INNER JOIN
     GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
WHERE  P.ImgQty>0 AND I.GeneralRandomNo>#imgBegin#   AND G.Gallery='PhotoShowcase' and G.Tier=1 AND I.ImageNumber=1 and P.ShowcaseOK=1 ORDER BY P.EXHIBITIONOPENED DESC 
<!--- ORDER BY I.GeneralRandomNo  --->
			</cfquery>
	...
	<!--- Took this out November 15, 2001 --->		
  <!--- <cfif counter is 1>
...
<!--- 	 <table border="0" align="center" width="100%">
	...
	<cfset firsttime=1>
	<cfset counter=1>
	<cfoutput query="qGetShowcaseSetupInfo" startrow=1 maxrows=100>
	 <cfif counter is 1>
	 <div align="center">  
...
<img src="Artists/#qGetShowcaseSetupInfo.Subdirectory#/#qGetShowcaseSetupInfo.Portfolio#/Images_Search/Image1.jpg" name="img2"  border="0"></a><br>
