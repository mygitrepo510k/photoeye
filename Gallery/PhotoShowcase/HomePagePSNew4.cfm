...
<CFSET xShowMenu = 1>
<cfinclude template="../../templates/Header4.cfm">
...
WHERE  P.ImgQty>0 AND G.Gallery='PhotoShowcase' and I.ImagePosition=1 and G.Tier=1 and P.ShowcaseOK=1 ORDER BY P.EXHIBITIONOPENED DESC 
<!--- ORDER BY I.GeneralRandomNo --->  <!--- AND I.GeneralRandomNo>#imgNextBeginNo#  ---> 
</cfquery>
...
<CFIF xPan is 1>									
	<img SRC="http://www.visualserver.com/artists/#qGetShowcaseSetupInfo.Subdirectory#/#qGetShowcaseSetupInfo.Portfolio#/search.gif" Border="1">
<CFELSE>
<!--- ImageSizer --->									
<cfset xheight=120>
<cfset xwidth=120>
...
<img src="../../_cache/#imagecr.filename#" height='#imagecr.height#' width='#imagecr.width#' border="1" ALT="#xAlt#">
<!--- End ImageSizer --->
</CFIF></a>
<br>
...
<!--- Show the Images for all additional Randomized rows for a total of 100 possible images --->
	...
	<cfset firsttime=1>
	<cfset counter=1>
	<cfoutput query="qGetShowcaseRandom" startrow=1 maxrows=200> <!--- was 92 --->
	 <cfif counter is 1>
	 <div align="center">  
...
<CFIF xPan is 1>									
	<img SRC="http://www.visualserver.com/artists/#qGetShowcaseRandom.Subdirectory#/#qGetShowcaseRandom.Portfolio#/search.gif" border="1">
<CFELSE>
<!--- ImageSizer --->									
<cfset xheight=120>
<cfset xwidth=120>
