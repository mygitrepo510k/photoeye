...
<img src="../SharedImages/dot_clear.gif" width="1" height="10"><div align="center"><b><font face="verdana, arial, helvetica, sans-serif" size="2" color="black">P 
    H O T O G R A P H E R ' S&nbsp;&nbsp;&nbsp;&nbsp;S H O W C A S E <sup><font size="1">SM</font></sup></font></b></div><hr width="400" size="1" noshade><font face="verdana, arial, helvetica, sans-serif" size="1" color="#666666"><b>
...
AutoID<>#ListGetAt(xAutoIDList, 1)# and 
AutoID<>#ListGetAt(xAutoIDList, 2)# and 
AutoID<>#ListGetAt(xAutoIDList, 3)# and
AutoID<>#ListGetAt(xAutoIDList, 4)# and
AutoID<>#ListGetAt(xAutoIDList, 5)# and
AutoID<>#ListGetAt(xAutoIDList, 6)# and
AutoID<>#ListGetAt(xAutoIDList, 7)# and
AutoID<>#ListGetAt(xAutoIDList, 8)# 
...
<img src="Artists/#qGetShowcaseRandom.Subdirectory#/#qGetShowcaseRandom.Portfolio#/Images_Search/Image#qGetShowcaseRandom.ImageNumber#.jpg" name="img2"  border="0"></a><br>
