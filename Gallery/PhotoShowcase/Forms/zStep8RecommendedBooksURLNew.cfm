            ...
            <table width="95%" border="0" cellpadding="5" bgcolor="#FFFFFF" cellspacing="0" valign="top" align="center">
              ...
              <tr> 
                <td width="49%" valign="top" height="525"> <font face="Verdana,Arial,Helvetica,sans-serif" color="#000000" size="2"><b>Influential 
                  ...
                  these titles, <a href="../../../indexbookstore.html" target="_blank">search 
		...
		<cfset number1=number> 
			...
			<cfset ColOneFavoriteBooksCatalogName = #Replace(ColOneFavoriteBooksCatalogNameNew, "00", Number1)#>  
				  ...
				  <table width="82%">
                    ...
                    <tr> 
                      <td width="33%"> 
                        <input type="text" size="13" maxlength="75" name="<cfoutput>ColOneFavoriteBooksTitleName</cfoutput>" <CFOUTPUT>value="#ColOneFavoriteBooksTitle#"</CFOUTPUT>>
                      </td>
                      <td width="33%"> 
                        <input type="text" size="13" name="<cfoutput>ColOneFavoriteBooksAuthorName</cfoutput>" maxlength="75" <CFOUTPUT>value="#ColOneFavoriteBooksAuthor#"</CFOUTPUT>>
                      </td>
                      <td width="34%"> 
                        <input type="text" size="6" name="<cfoutput>ColOneFavoriteBooksCatalogName</cfoutput>" maxlength="6" <CFOUTPUT>value="#ColOneFavoriteBooksCatalog"</CFOUTPUT>>
                      </td>
                    </tr>
                  </table>
                  <br>
