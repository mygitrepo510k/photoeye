...
<table border="0">
 ...
 <cfif qGetShowcaseSetupInfo.multiartists is 0>
  ...
  <cfelse>
    ...
    <td  width="17%" colspan="3">
	<br>
  <font face="Verdana,Arial,Helvetica,sans-serif" size="2" color="silver">Steps 8-10 are disabled<br>for Multiple Artist Portfolios</font>
    <br>
  </td></tr>
  </cfif> <!--- If not MultiArtists --->
