...
<!--- <form method="post" action="changeorder.cfm"> --->
...
<br>The sequence number will be skipped and the image won't appear in your portfolio if the image indicates Not Shown. This is a rarely chosen option in the Image Availability section of the Edit Artwork Description form.</font><hr size="1" noshade color="black">
        ...
        <form method="post" action="CheckDuplicatePositionsa.cfm?custnumber=<cfoutput>#url.custnumber#</cfoutput>">
			...
			<cfset imagecount = 0>
			<cfloop index="fieldincrementer" from="1" to="20" step="1">
				<cfif fileexists(Expandpath("../../#qGetShowcaseSetup.Gallery#/Artists/#qGetShowcaseSetup.Subdirectory#/#qGetShowcasePortfolio.SubDirectory#/Images_Thumbs/image#fieldincrementer#.jpg"))>	
...
<!--- 			imageposition #qShowcaseGalleryIndividualPhotos.imageposition#<br>
			...
			<cfif fileexists(Expandpath("../../#qGetShowcaseSetup.Gallery#/Artists/#qGetShowcaseSetup.Subdirectory#/#qGetShowcasePortfolio.SubDirectory#/Images_Thumbs/image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg"))>		
				<cfset imageno=#qShowcaseGalleryIndividualPhotos.imagenumber#><a href="step12artworkdescriptionformSequence.cfm?custnumber=#qShowcaseGalleryIndividualPhotos.custnumber#&imagenumber=#imageno#&imagenumbercounter=#imageno#&Portfolio=#qGetShowcasePortfolio.SubDirectory#"><img src="../../#qGetShowcaseSetup.Gallery#/Artists/#qGetShowcaseSetup.Subdirectory#/#qGetShowcasePortfolio.SubDirectory#/Images_Thumbs/image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg">
...
<a href="step12artworkdescriptionformSequence.cfm?custnumber=#qShowcaseGalleryIndividualPhotos.custnumber#&imagenumber=#imageno#&imagenumbercounter=#imageno#&Portfolio=#qGetShowcasePortfolio.SubDirectory#"><img src="../../#qGetShowcaseSetup.Gallery#/Artists/#qGetShowcaseSetup.Subdirectory#/#qGetShowcasePortfolio.SubDirectory#/Images_Thumbs/image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg">
