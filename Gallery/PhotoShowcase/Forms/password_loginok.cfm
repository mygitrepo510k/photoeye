...
<br>
   ...
   <table width="85%" bgcolor="#FFFFFF" align="center">
      <tr><td align="center"> 
         ...
         <TR> 
                <TD COLSPAN="3" ALIGN="LEFT"><font face="Verdana,Arial,Helvetica,sans-serif" size="4">Artist
                  Login </font><font face="Verdana,Arial,Helvetica,sans-serif" size="5"><br>
