...
<!--- See how many Portfolio Directories have been created --->

<cfset Dir=ExpandPath("../../../gallery/#qGetShowcaseSetup.Gallery#\Artists\#qGetShowcaseSetup.Subdirectory#")>
...
<cfset PortfolioQty=#qDirectory.recordcount#+1>


<!--- End of seeing how many portfolios have been created --->


<!--- <CFQUERY NAME="qPortfolioQty"  DATASOURCE="photoeyecom">
  SELECT *
  FROM GalleryPortfolio where custnumber = '#url.id#' 
</CFQUERY>

<cfset PortfolioQty = #qPortfolioQty.recordcount#+1> --->
...
<!---  <form action="test.cfm?Custnumber=<cfoutput>#url.custnumber#</cfoutput>&RequestTimeOut=10000" method="post"> --->
 ...
 <FORM ACTION="UploadImagesAction.cfm?id=<cfoutput>#url.id#&portfolio=Portfolio#portfolioQty#</cfoutput>&RequestTimeOut=10000" METHOD="POST" ENCTYPE="multipart/form-data" TARGET="_top"> 
        ...
        <table width="95%" border="0" cellpadding="5" bgcolor="#FFFFFF" cellspacing="0" valign="top" align="center">
          ...
          <tr valign="top"> 
            <td colspan="3" align="LEFT"> <font face="Verdana,Arial,Helvetica,sans-serif" size="4">Step 
              2 - Upload Images for this Portfolio</font><font face="Verdana,Arial,Helvetica,sans-serif" size="5"><br>
