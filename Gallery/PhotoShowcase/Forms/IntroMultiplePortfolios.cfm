          ...
          <table width="95%" border="0" cellpadding="5" bgcolor="#FFFFFF" cellspacing="0" valign="top" align="center">
            <tr valign="top"> 
              <td colspan="3" align="left"><font face="Verdana,Arial,Helvetica,sans-serif" size="5"><font size="2"><img src="../SharedImages/photo-eye%20Explore%20NewLogo_photoShowcaseVersionWhiteBackground.jpg" width="151" height="94"></font></font></td>
			    ...
			    <TD COLSPAN="3" ALIGN="LEFT"><font face="Verdana,Arial,Helvetica,sans-serif" size="4">Portfolios</font><font face="Verdana,Arial,Helvetica,sans-serif" size="5"> 
                  <br>
                  <font size="2">Choose your Portfolio to Administer<br>
                  <br>
...
<cfoutput>
			...
			<cfif fileexists(Expandpath("../../#qGetShowcaseSetupInfo.Gallery#/Artists/#qGetShowcaseSetupInfo.Subdirectory#/Portfolio#portfolionumber#/Images_Thumbs/image1.jpg"))>		
				<a href="indexadminMultiplePortfolios.cfm?custnumber=#url.custnumber#&portfolio=Portfolio#portfolionumber#" target="_parent"><img src="../../#qGetShowcaseSetupInfo.Gallery#/Artists/#qGetShowcaseSetupInfo.Subdirectory#/Portfolio#portfolionumber#/Images_Thumbs/image1.jpg" border="0"></a>
			    <br><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><a href="indexadminMultiplePortfolios.cfm?custnumber=#url.custnumber#&portfolio=Portfolio#portfolionumber#" target="_parent">Administer this  Portfolio</a></b></font><br><br>
		...
		<cfif #trim(qGetShowcaseSetupInfo.gallery)# is not "PhotoShowcase">
				<br><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><a href="????.cfm?custnumber=#url.custnumber#&portfolio=Portfolio#portfolionumber#" target="_parent">Add Additional Portfolios</a></b></font>
		<cfelse>
		test
		</cfif>
