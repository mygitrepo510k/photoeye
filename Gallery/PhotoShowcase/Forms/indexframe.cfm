...
<table border="0">
  ...
  <tr> 
	...
	<cfif #len(trim(qGetShowcaseDefault.PortfolioName))# GT 0>
	 ...
	 <cfif #len(trim(#qGetPortfolio.Title#))# is not #len(trim(qGetShowcaseDefault.PortfolioName))#>
  ...
  <cfelse>
	...
	<br>
  <font face="Verdana,Arial,Helvetica,sans-serif" size="2" color="Silver">Steps 2-6 are disabled<br>for Multiple Artist Portfolios</font>
  	<br><br>
  </td></tr>
  </cfif> 
  ...
  <cfelse>
    ...
    <td width="17%" colspan="3">
	<br>
  <font face="Verdana,Arial,Helvetica,sans-serif" size="2" color="silver">Steps 8-10 are disabled<br>for Multiple Artist Portfolios</font><br></td></tr>
  </cfif> 
  <tr> 
    <td width="17%">&nbsp;</td>
    <td width="8%">&nbsp;</td>
...
<!---     <td width="75%"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="indexmultipleportfoliosMore.cfm?custnumber=<cfoutput>#qGetShowcaseSetupInfo.Custnumber#</cfoutput>" target="_parent">More Portfolios</a> </font></td> --->
    <td width="75%"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">-&nbsp;<a href="multipleportfolios.cfm?id=<cfoutput>#qGetShowcaseSetupInfo.Custnumber#</cfoutput>" target="_parent">More Portfolios</a> </font></td>
  </tr>
  <tr>
    <td width="17%"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">Step</font></td>
    <td width="8%"><font face="Verdana,Arial,Helvetica,sans-serif" size="2">16</font></td>
