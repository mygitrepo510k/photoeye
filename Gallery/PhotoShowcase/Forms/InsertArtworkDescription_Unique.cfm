...
<cfif #form.CopyrightDefault# is 1>
	   <CFSET #Copyright# ="">
	   <CFSET #CopyrightDefault# = 1>
<cfelseif #len(trim(form.Copyright))# is 4>
	  <CFSET #Copyright# ="#form.Copyright#">
	  <CFSET #CopyrightDefault# = 0>
<cfelse>
	  <CFSET #Copyright# ="#YEAR(Now())#">
	  <CFSET #CopyrightDefault# = 0>	  
</cfif>
...
<CFTRANSACTION>
  ...
  UPDATE GalleryIndividualPhotos
   SET Title = '#Title#',
	...
	Default6 = '#Default6#',
	Copyright = '#Copyright#',
	CopyrightDefault = '#CopyrightDefault#',	
	Genre1 = '#Genre1#',
	Default9 = '#Default9#',
	Format1 = '#Format1#',
	...
	Default8 = '#Default8#',
	Default5 = '#Default5#',
 	Editioned1 = #Editioned1#,
	EditionSz1 = '#EditionSz1#',
	EditionNo1 = '#EditionNo1#',	
...
WHERE Custnumber = #form.Custnumber# and DefaultKW=0 and  Catalog=#qGetShowcaseUniqueInfo.Catalog# and catalog>0
...
<cfelse>
	...
	<cfquery name="qUpdateInventory" DATASOURCE="photoeyecom" dbtype="ODBC">
		UPDATE Inventory 
		SET
		<cfif #form.Default1# is 0>TITLE2X='#Title#',</cfif>
