...
<br>
    <table width="85%" bgcolor="White" align="center">
      <tr><td align="center">
...
2. Life in Iran</font></font><br><br><font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"><b>This Portfolio Title:</b></font><br>
                <input type="text" size="40" maxlength="100" name="PortfolioName"value="#qGetShowcaseDefaultInfo.PortfolioName#">
                <br>
...
<!--- 				<font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"><b>This Portfolio Title:</b></font><br> --->
 <textarea name="PortfolioIntro" rows="5" cols="40">#qGetShowcasePortfolio.PortfolioIntro#</textarea>
	 ...
	 <img src="Images/BlackRule.gif" width=100% height=1 alt="" border="0">
                ...
                <br>       <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="2"><b>
                General Print Information:<br></b><br>
                ...
                <input type="text" size="40" maxlength="75" name="Title"value="#qGetShowcaseDefaultInfo.Title#">
                <br><br>
                ...
                <input type="text" size="6" maxlength="4" name="YearProd" value="#qGetShowcaseDefaultInfo.YearProd#">
               		 <br><br>
...
<!---                   			<option value="Color" <CFIF #qGetShowcaseDefaultInfo.Medium# is "Color">SELECTED</CFIF>>Color  --->
                ...
                <br><br>
                <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1">           <b>Other Process:</b>    If none of the above process are appropriate, choose <b>Other Process</b> from the above list and define your Process below. Your work will be included in the Process directory under the heading  <b>Other Process</b>.<br>
                <input type="text" size="40" maxlength="75" name="OtherMed" value="#qGetShowcaseDefaultInfo.OtherMed#">
                <br>
...
<!---                   <option value="Cityscape" <CFIF #qGetShowcaseDefaultInfo.Genre1# is "Cityscape">SELECTED</CFIF>>Cityscape  --->
                  ...
                  <option value="Unclassified" <CFIF #qGetShowcaseDefaultInfo.Genre1# is "Unclassifed">SELECTED</CFIF>>Unclassified
            ...
            <b>Other Genre:</b>    If none of the above genres are appropriate, choose <b>Other Genre</b> from the above list and define your genre below. Your work will be included in the Genre directory under the heading entitled <b>Other Genres</b>.<br>
                <input type="text" size="40" name="Genre2" maxlength="75" value="#qGetShowcaseDefaultInfo.Genre2#"> 
                </font></font>
...
<!---                   <option value="Not Appropriate" <CFIF #qGetShowcaseDefaultInfo.Format1# is "Not Appropriate">SELECTED</CFIF>>Not Appropriate ---> 
               ...
               <b>Other Format</b>: If none of the above formats or camera types are appropriate, choose <b>Other Format</b> from the above list and define your format below. Your work will be included in the Format directory under the heading entitled <b>Other Formats</b>.<br>
                <input type="text" size="40" name="Format2" maxlength="75" value="#qGetShowcaseDefaultInfo.Format2#"> 
                </font></font>				  
				 <br>
  ...
  Not for Sale - Other</font></b> 
              ...
              <td valign="top" width="49%">
                <table><tr><td colspan="2"> <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="2"><b> 
				Print Dimensions:</b> <font size="1">(in inches)</font><br>
                <font size="1">Only one size may be offered in our e-commerce engine. Enter your most popular size below. Additional sizes and their respective prices may be listed in the text box further down this page. Place all basic default print information in the 
				...
				<font color="red">Do not include inch marks (&quot;).</font></font></font><br>
                  ...
                  <tr> 
                    <td><font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"> 
                      ...
                      <input type="text" size="3" name="Height1" maxlength="3" value="#qGetShowcaseDefaultInfo.Height1#">
                    </td>
                    <td><font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"> 
                      <b>Image Width:</b>&nbsp;</font> 
                      <input type="text" size="3" name="Width1" maxlength="3" value="#qGetShowcaseDefaultInfo.Width1#"><br>
					</td>
                  </tr>
				  <tr>
				   <td colspan="2">
                ...
                Mat Dimensions: </b><font size="1">(in inches)</font></font><br>
				    ...
				    All photographs must be matted using archival mat board. We recommend that you use a professional matter. Optionally we can mat your work for you, deducting our fee from your percentage. <font color="Red">However, please indicate the size of the mat
				  here, regardless as to who mats your work.</font></font></td></tr>

					 <tr>
					 <td width="50%" height="33"><font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"><b>Mat Height:</b>&nbsp;</font> 
                      <input type="text" size="3" name="MatHeight1" maxlength="3" value="#qGetShowcaseDefaultInfo.MatHeight1#">
                    </td>
                    <td width="50%" height="33"><font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"><b> 
                      Mat Width:</b>&nbsp;</font> 
                      <input type="text" size="3" name="MatWidth1" maxlength="3" value="#qGetShowcaseDefaultInfo.MatWidth1#">
</tr>
			  <tr> <td COLSPAN="2">	  
				  <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1">
                ...
                are responsible for updating any price increases. <font color="Black">DO NOT use a separator ",", a $ sign, or a decimal point. EG. Instead of $1,500.00 type 1500.<BR><BR>&nbsp;<font size="2"><b>$ 
                      <input type="text" size="6" name="Price1" maxlength="7" value="#qGetShowcaseDefaultInfo.Price1#">
				...
				<font size="1" color="red">1/25 (1 is the 1st print of the edition, 25 is the edition size)</font></font><table width="229">
                  <tr> 
		        ...
		        <table>
                  <tr> 
                    <td> <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"><b>Print No.:</b>&nbsp;</font> 
                      <input type="text" size="4" name="EditionNo1" maxlength="4" value="#qGetShowcaseDefaultInfo.EditionNo1#">
                    </td>
                    <td>
					
					 <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"><b>Ed.
                      Size:</b>&nbsp;</font> 
                      <input type="text" size="4" name="EditionSz1" maxlength="4" value="#qGetShowcaseDefaultInfo.EditionSz1#">
                    </td>
                ...
                <br><font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="2"><b>Print Sizes or Ltd. Ed. Price Structure:<br></b>
				  <font size="1">If prints are offered in different sizes apart from the standard size you've already input, then list that information below. If prints are editioned, list the pricing structure below.<font color="red" size="1">Note: You must include a &lt;br&gt; after each line and two breaks &lt;br&gt;&lt;br&gt; to make a blank line.</font></font><table cellspacing="0" cellpadding="0" width="248">
                  <tr> 
...
&lt;br&gt;&lt;br&gt;</font></td></tr>
                ...
                <textarea name="AddInfo1" rows=20 cols=32 wrap=virtual>#qGetShowcaseDefaultInfo.AddInfo1#</textarea>
              </td>
            </tr>
            <br>
      ...
      any or all of the fields below. Otherwise, choose <i>Not Applicable</i> in the drop-down box below.  This may be overridden for particular images in Step 12.</font></font></td>
            </tr>
            <tr> 
              <td align="left"> <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"> 
                ...
                <input type="text" size="30" name="LocCountry" maxlength="75" value="#qGetShowcaseDefaultInfo.LocCountry#">
                <br>
                <br>
                <b>Region:</b> example - Bandereas<br>
                <input type="text" size="30" name="LocRegion" maxlength="75" value="#qGetShowcaseDefaultInfo.LocRegion#">
                </font> </TD>
              <td>&nbsp;</td>
              <td> <br>
                <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"> 
                <b>State:</b> example - New Mexico<br>
                <input type="text" size="30" name="LocState" maxlength="75" value="#qGetShowcaseDefaultInfo.LocState#">
                <br>
                <br>
                <b>City:</b> example - Taos<br>
                <input type="text" size="30" name="LocCity" maxlength="75" value="#qGetShowcaseDefaultInfo.LocCity#">
                <br>
                <br>
                </font><br>
                <br>
            ...
            <tr> 
              <td colspan="3" align="left"> 
                ...
                <font size="1">This section is <font color="red">very important</font> 
      ...
      Endangered Cultures, Tribal<br>
                ...
                example.<br>
                <textarea name="Keywords" rows=3 cols=60 wrap=virtual>#CompiledKeywords#</textarea>             
                </font></font></td>
            </tr>
            <tr> 
