...
<br>The sequence number will be skipped and the image won't appear in your portfolio if the image indicates Not Shown. This is a rarely chosen option in the Image Availability section of the Edit Artwork Description form.</font><hr size="1" noshade color="black">
        ...
        <form method="post" action="CheckDuplicatePositionsa.cfm?custnumber=<cfoutput>#url.custnumber#</cfoutput>">
			...
			<cfloop index="fieldincrementer" from="1" to="#qShowcaseGalleryIndividualPhotos.recordcount#" step="1">
				<cfif fileexists("#xRelativePath#\artists\#qGetShowcaseSetup.Subdirectory#\#qGetShowcasePortfolio.SubDirectory#\Images_Large\image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg")>	
...
<!--- End ImageSizer --->
	...
	<!--- If there are 21-25 images show this table--->
          <cfif #imagecount# GT 20>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr> 
		<cfloop QUERY=qShowcaseGalleryIndividualPhotos startrow="21" endrow="25">
			<td align="center" width="10%">
			<cfif fileexists("#xRelativePath#\artists\#qGetShowcaseSetup.Subdirectory#\#qGetShowcasePortfolio.SubDirectory#\Images_Large\image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg")>
<!--- 			<cfif fileexists(Expandpath("../../../../visualserver/Artists/#qGetShowcaseSetup.Subdirectory#/#qGetShowcasePortfolio.SubDirectory#/Images_Large/image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg"))>	 --->
 				<cfset imageno=#qShowcaseGalleryIndividualPhotos.imagenumber#><a href="step12artworkdescriptionformSequence.cfm?custnumber=#qShowcaseGalleryIndividualPhotos.custnumber#&imagenumber=#imageno#&imagenumbercounter=#imageno#&Portfolio=#qGetShowcasePortfolio.SubDirectory#">
...
<!--- End ImageSizer --->
              ...
              <tr> 
				...
				<td width="10%" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Position 
                  ...
                  to Position:</font> 
                  	 <cfif #clear# is 0>
				  	     <input type="text" name="image21" size="2" maxlength="2" value="21">
					<cfelse>
						 <input type="text" name="image21" size="2" maxlength="2" value="">
					</cfif>
                  <br>
                </td>
				<cfelse>
				...
				<cfif #imagecount# GT 21>
                <td width="10%" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Position 
                  22</font> <br>
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Change 
                  to Position:</font> 
                  	 <cfif #clear# is 0>
				  	     <input type="text" name="image22" size="2" maxlength="2" value="22">
					<cfelse>
						 <input type="text" name="image22" size="2" maxlength="2" value="">
					</cfif>
                  <br>
                </td>
				<cfelse>
	    		...
	    		<cfif #imagecount# GT 22>    
                <td width="10%" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Position 
                  23</font> <br>
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Change 
                  to Position:</font> 
                  	 <cfif #clear# is 0>
				  	     <input type="text" name="image23" size="2" maxlength="2" value="23">
					<cfelse>
						 <input type="text" name="image23" size="2" maxlength="2" value="">
					</cfif>
                  <br>
                </td>
				<cfelse>
    			...
    			<cfif #imagecount# GT 23>            
				<td width="10%" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Position 
                  24</font> <br>
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Change 
                  to Position:</font> 
                  	 <cfif #clear# is 0>
				  	     <input type="text" name="image24" size="2" maxlength="2" value="24">
					<cfelse>
						 <input type="text" name="image24" size="2" maxlength="2" value="">
					</cfif>
                  <br>
                </td>
				<cfelse>
                ...
                <td width="10%" align="center"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Position 
                    ...
                    to Position:</font> 
                  	 <cfif #clear# is 0>
				  	     <input type="text" name="image25" size="2" maxlength="2" value="25">
					<cfelse>
						 <input type="text" name="image25" size="2" maxlength="2" value="">
					</cfif>
                  </p>
               	 </td>
				<cfelse>
...
<table align="center"><tr align="center"><td align="center">				
 <br>
        <hr color="black" size="1">
            ...
            © photo-eye books &amp; prints, 2003. All Rights Reserved.</font> 
            <br>
