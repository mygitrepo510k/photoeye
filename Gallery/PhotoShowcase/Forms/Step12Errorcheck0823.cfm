...
<cfif #form.Default2# is 0 and #form.Medium# is 'Other Process' and #len(form.OtherMed)# is 0>
	<cfset error=4>
</cfif>
...
an error is generated--->
<cfif #form.Default2# is 0 and #len(form.OtherMed)# GT 0 and #form.Medium# IS NOT 'Other Process'>
	<cfset error=4>
</cfif>
...
<cfif #form.Default5# is 1 and (#form.Editionedx# is 1 or #len(form.EditionSz1)# GT 0 or #len(form.EditionNo1)# GT 0)>
	<cfset error=1>
	<!--- 6= #form.Default6#  --->
</cfif>

<!--- <cfif #form.editioned1# is 1 and (#len(form.EditionSz1)# is 0 or #len(form.EditionNo1)# is 0) and #form.default5# is 1>
	<cfset error=1>
	<!--- 6= #form.Default6#  --->
</cfif> --->
...
<!--- <cfif #form.Default5# is 0 and #len(form.addinfo1)# is 0 and #form.Editioned1# is 1>
	<cfset error=1>
<!--- 	8=#form.Default8# --->
</cfif> --->
...
<!--- If Unique is Chosen, make sure there is information entered --->
 <cfif #form.Default5# is 0 and #form.editionedx# is 1 and (#len(trim(form.editionsz1))# is 0 and #len(trim(form.editionno1))# is 0)>

	<cfset error=2>
</cfif> 

<!--- If Unique is Chosen, make sure there is information entered --->
		 <cfif #form.Default5# is 0 and #form.editionedx# is 1 and #len(trim(form.editionsz1))# is 0 and #len(trim(form.editionno1))# GT 0>
...
<cfif  #form.default5# is 1 and #form.editionedx# is 1 and (#len(form.EditionSz1)# GT 0 or #len(form.EditionNo1)# GT 0)>
	   <cfset error=2>
</cfif>
...
<cfif #form.default5# is 1 and (#form.editionedx# is 1 or len(trim(#form.editionsz1#)) GT 0 or len(trim(#form.EditionNo1#)) GT 0)>
	<cfset error=3>
</cfif>

<cfif #form.editionedx# is 0 and (len(trim(#form.editionsz1#)) GT 0 or len(trim(#form.EditionNo1#)) GT 0)>
	<cfset error=3>
</cfif>
...
<cfif #form.Default7# is 0 and #val(form.Price1)# LT 100>
	<cfset error=3>
</cfif>
...
<!--- <cfif #form.default8# is 1 and #form.Editionedx# is 0>	
	<cfset error=3>
</cfif> --->
...
<!--- 		<cfif #form.Editionedx# is 1 and #form.Default5# is 0 and (#len(form.editionNo1)# is 0 or #len(form.editionSz1)# is 0)>
			Limited Editions<br>
...
<cfif #form.default5# is 1 and (len(trim(#form.editionsz1#)) GT 0 or len(trim(#form.EditionNo1#)) GT 0)>
		Limited Edition<br>
...
<cfif #form.default5# is 1 and #form.editionedx# is 1>
		Limited Edition<br>
		You have chosen the <i>Use Default</i> option.<br>
...
<!--- 	
	...
	<cfelseif #val(form.Price1)# LT 100 and form.default7 is 0>
