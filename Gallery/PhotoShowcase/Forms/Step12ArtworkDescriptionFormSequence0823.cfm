...
<table width="85%" bgcolor="##FFFFFF"  align="center">
 ...
 <textarea name="Caption" rows="5" cols="40">#qGetShowcaseIndividualInfo.Caption1#</textarea>
                    ...
                    <!--- If there is a Default show Radio Buttons/Default Info here --->
				      <tr> 
                        ...
                        <div align="left"> 
						  ...
						  <cfelse>
						 	 #qGetShowcaseDefaultPhotos.Genre2#<br>
                    ...
                    <!--- If there is a Default show Radio Buttons/Default Info here --->
				      <tr> 
                        ...
                        <div align="left"> 
                          ...
                          <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1"> 
                          Use Default:<font color="red"> 						  
						  <cfif #Len(qGetShowcaseDefaultPhotos.Format1)# is not 0>
						  	 #qGetShowcaseDefaultPhotos.Format1#<br>
						  <cfelse>
						 	 #qGetShowcaseDefaultPhotos.Format2#<br>
                      	  </cfif></font></font></div></td>
                      </tr>
                      <tr> 
                         <td height="32"> 
...
<!---                   <option value="Not Appropriate" <CFIF #qGetShowcaseIndividualInfo.Format1# is "Not Appropriate">SELECTED</CFIF>>Not Appropriate ---> 
               ...
               <b>Other Format</b>: If none of the above formats or camera types are appropriate, choose <b>Other Format</b> from the above list and define your format below. Your work will be included in the Format directory under the heading entitled <b>Other Format</b>.<font color="Red">Capitalize all primary words.</font><br>
                <input type="text" size="40" name="Format2" maxlength="75" value="#qGetShowcaseIndividualInfo.Format2#"> 
                </font></font></td>
  ...
  <input type="radio" name="NotAvailable" value="3" <cfif #qGetShowcaseDefaultPhotos.NotAvailable# is "3"> checked </cfif>>
   Use Default:  <font color="Red">Not for Sale - Other </font>
  					   </cfif>
					   </font></td>
					   </tr>
					    <tr> 
				   ...
				   <table cellspacing="0" cellpadding="0">
				      ...
				      <tr> 
						...
						<br> 
						  ...
						  <cfelse>
						 	 <input type="radio" name="Default5" value="1">
						  </cfif>
                      ...
                      <tr> 
                        ...
                        <div align="left"> 
						 ...
						 <cfelse>
                          ...
                          <font face="Verdana,Arial,Helvetica,sans-serif" color="##000000" size="1">Unique to this print, fill in fields below:<br>

	                     <cfif #qGetShowcaseIndividualInfo.editioned1# is 0>
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Editionedx" value=0 checked>            
                          Not Editioned <br>	
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Editionedx" value=1>
                          Editioned
						  <cfelse>
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Editionedx" value=0>            
                          Not Editioned
...
<!--- 				 
      ...
      keywords that describe your work, <b>excluding</b> <b>Location</b> and <b>Genre</b>. <font color="Red">When appropriate, use the plural of the word (eg. boys instead of boy, children instead of child). 
      <br>
