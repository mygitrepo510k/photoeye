...
WHERE (Custnumber = #qGetShowcaseRandom.Custnumber#)
		 ...
		 <a href="../forms/index.cfm?image=#ImageNumber#&id=#qGetShowcaseRandom.Custnumber#&imagePosition=#ImagePosition#&Door=2&Portfolio=#qGetShowcaseRandom.Portfolio#&Gallery=2" target="_top">
