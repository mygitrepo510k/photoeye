...
SELECT G.SubDirectory as SubDirectory, G.Firstname as Firstname, p.ImgQty as ImageQTy, G.Lastname as Lastname, G.Gallery as Gallery, G.Custnumber as Custnumber, I.ImageNumber as Imagenumber, I.ImagePosition as ImagePosition, I.GeneralRandomNo as GeneralRandomNo, 
...
WHERE   G.Custnumber = P.Custnumber and G.Custnumber = D.Custnumber AND P.Subdirectory = D.Subdirectory AND P.ImgQty>0 AND GenreRandomNo>#begin# AND I.Selected=1 
...
<cfoutput>
  ...
  <cfif counter is 1>
	...
	<cfelse>
	<a href="moreselectedimages.cfm?page=#counter#&additional=#additional#&Begin=#qGetShowcaseSetupInfo.GeneralRandomNo#"><FONT color="silver" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='silver';"  style="TEXT-DECORATION: none"><b>#counter#</b></font></a>
	</cfif>
  </cfif>
  ...
  <cfif counter is 11>
	...
	<cfelse>
	- <a href="moreselectedimages.cfm?page=#counter#&additional=#additional#&Begin=#qGetShowcaseSetupInfo.GeneralRandomNo#"><FONT color="silver" face="verdana, arial, Helvetica, sans-serif" size="1" onMouseover="this.color='RED';" onMouseout="this.color='silver';"  style="TEXT-DECORATION: none"><b>11+</b></font></a>
	</cfif>
 	<cfbreak>
  </cfif>
...
<cfloop query="qGetShowcaseSetupInfo" startrow="1" endrow="20">
  <cfif Column is 1>
    ...
    <td height="103" align="center">
	 <a href="javascript:popUp('forms2/index.cfm?id=#qGetShowcaseSetupInfo.Custnumber#&image=#ImageNumber#&imagePosition=#ImagePosition#&Door=3&Portfolio=#qGetShowcaseSetupInfo.Portfolio#','Showcase','700','480','no');"><img src="#qGetShowcaseSetupInfo.Gallery#/Artists/#qGetShowcaseSetupInfo.Subdirectory#/#qGetShowcaseSetupInfo.Portfolio#/Images_Search/Image1.jpg" name="img2"></a></td>
