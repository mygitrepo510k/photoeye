...
ORDER BY  CONVERT(char(20), P.ExhibitionOpened, 102) DESC, D.GeneralRandomNo  
					...
					<cfset xImage='Image19'>
                    <cfset qGetSantaFe.Subdirectory = 'JockSturges'>
                    <cfset qGetSantaFe.firstname="Jock">
                    <cfset  qGetSantaFe.Lastname="Sturges"> 
                    <cfset qGetSantaFe.ImageNumber = "19">								
					<cfset xheight=600>
					<cfset xwidth=500>
...
<a href="/gallery/forms2/index.cfm?image=1&id=42111&imagePosition=18&Door=1&Portfolio=Portfolio1&Gallery=1&Page="><img src="/artists/#qGetSantaFe.Subdirectory#/#qGetSantaFe.Portfolio#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#xAlt#"></a>
</div>
...
<font size="3"><b>J O C K &nbsp; S T U R G E S : &nbsp; W O R K &nbsp; F R O M &nbsp; T W O &nbsp; N E W &nbsp; M O N O G R A P H S</b></font>
<br />`<br />September 19 - November 1, 2008 at photo-eye Gallery, Santa Fe.<BR /><BR /><a href="/bookstore/citation.cfm?catalog=AP566&i=9781597110747"><em>Misty Dawn. Portrait of a Muse</em></a> published by Aperture and <a href="/bookstore/citation.cfm?catalog=DQ095&i=9783865217004"><em>Life Time</em></a> published by Steidl.
<!---Please join us for an evening of live jazz with the Santa Fe Jazz Quartet to accompany a booksigning and reception for<br /> Julie Blackmon. Julie will be signing her <a href="http://test.photoeye.com/templates/mShowDetailsbycatAmazon.cfm?Catalog=DP941&i=9781934435045">first monograph</a> published by RADIUS BOOKS. --->
</font>
