...
<!---   <cfset qGetSantaFe.Subdirectory = 'JoWhaley'>
		...
		<div class="FeatureSpotImage">			
					<cfset xalt="Photographer's Showcase Exhibition Series Announcment Card">
		
		<a href="RepresentedArtists/"><img src="/img/gallery/kickoff_final-1.jpg" border="0" ALT="#xAlt#"></a><!---<span class="GalleryImageAuthor">#trim(qGetShowcase.Firstname)# #trim(qGetShowcase.Lastname)#</span><img src="/artists/#qGetSantaFe.Subdirectory#/#qGetSantaFe.Portfolio#/Images_Large/#xImage#_H#xWidth#xW#xHeight#.#xImageFormat#" border="0" ALT="#xAlt#"></a><span class="GalleryImageAuthor">#qGetSantaFe.Firstname# #qGetSantaFe.Lastname#</span>---></div>
            <div class="FeatureSpotText"><div class="FeatureSpotH1"><a href="RepresentedArtists/">Santa Fe Gallery</a> </div>March 20th - May 2nd, 2009<br />
<div class="GalleryH1">The Photographer's Showcase Exhibition Series</div><br />
