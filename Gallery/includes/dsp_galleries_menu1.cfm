...
ORDER BY  CONVERT(char(20), P.ExhibitionOpened, 102) DESC, D.GeneralRandomNo  
		...
		<!--- RR New shows: Need to manually put this in --->
				...
				<!--- ImageSizer --->	
					...
					<cfset xImage='Image1'>46396
                    <cfset qGetSantaFe.Subdirectory = 'GalisteoBasin'>
                    <cfset qGetSantaFe.firstname="Greg">
                    <cfset  qGetSantaFe.Lastname="MacGregor"> 
...
<a href="http://www.galisteobasinPhotoProject.cfm" target=_blank><img src="/artists/#qGetSantaFe.Subdirectory#/#qGetSantaFe.Portfolio#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#xAlt#"></a>
</div>
...
<font size="3"><b>T H E &nbsp; G A L I S T E O &nbsp; B A S I N &nbsp; P H O T O G R A P H I C  &nbsp; P R O J E C T</b></font>
<br />`<br />January 23rd through March 7th, 2009 at photo-eye Gallery, Santa Fe<BR /><BR />
</font>
