...
<div id="Portfolio_Info">
	...
	<cfif qShowcaseArtist.Firstname is 'Jock' and qShowcaseArtist.Lastname is 'Sturges'>
		<span style="font-size:14px;"><a href="http://www.photoeye.com/bookstore/citation.cfm?catalog=ZF561">Just Released:</a> <a href="http://www.photoeye.com/bookstore/citation.cfm?catalog=ZF561">Fanny</a><br /><br />
		 <a href="http://www.photoeye.com/bookstore/citation.cfm?catalog=ZF561"><img src="http://www.photoeye.com/_cache/9fe3eda221db28ff004b60127c9d52e5.jpg"></a>
		<br /><br />
		 <a href="mailto:gallery@photoeye.com?Subject=Jock Sturges">Email</a> or call 505.988.5152 x121 to order prints</span>
	...
	<cfif qShowcaseArtist.Firstname is 'John' and qShowcaseArtist.Lastname is 'Chervinsky'>
		<span style="font-size:12px;"><br />View the Limited Edition book <a href="http://www.photoeye.com/bookstore/citation.cfm?catalog=ZG215">An Experiment in Perspective</a><br /><br />
		 <a href="http://www.photoeye.com/bookstore/citation.cfm?catalog=ZG215"><img src="http://www.photoeye.com/_cache/4eff71907513ca7a96cc650bd7cdfcd3.jpg"></a>
		<br /><br />
		 Individual images may be ordered below</span>
	</cfif>
</div>
...
<cfelseif url.id is 201591 and url.Portfolio is 'Portfolio1'>
	var ContainerHeight = (Math.ceil(<cfoutput>#xCounter#</cfoutput>/7)*405)+'px';  
<cfelse>
	var ContainerHeight = (Math.ceil(<cfoutput>#xCounter#</cfoutput>/7)*205)+'px';
</cfif>
$('Img_Container').setStyle({height:ContainerHeight});
window.name = 'PEMain';
</script>
<!---RR 8/21/2013 margin-top:50px 290--->
<div id="TogHowTo" onclick="$('HowTo').toggle()" style="text-align:center; 	cursor:pointer;color:#A8905C;padding-top:440px;text-transform:uppercase;margin-bottom:5px;font-size:10px">How to use our image viewer</div>
