...
<CFIF #qGalleryEducation.recordcount# is not 0><a href="##Education"><font style="text-decoration:none">|&nbsp;Education</font></a>
<cfset headercount = headercount+1>
</cfif>
...
<CFIF len(#qGalleryBibliography.Title#) is not 0>
	...
	<!--- If there is a period at the end of the title, strip it away--->
				...
				<CFIF len(trim(#qGalleryBibliography.Catalog#)) is not 0>
					...
					<a href="../../templates/Citation.cfm?Catalog=#Left(qGalleryBibliography.Catalog,5)#&Showcase=1&&ArtistF=#qGallerySetup.FirstName#&ArtistL=#qGallerySetup.LastName#">
					#cTitle#</a>. 
					</cfif>
