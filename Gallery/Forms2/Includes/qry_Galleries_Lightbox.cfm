...
WHERE Custnumber=<cfqueryparam value="#url.id#" cfsqltype="CF_SQL_INTEGER">
	...
	<!---	 <cfif CGI.X_FORWARDED_FOR is '208.85.32.248'>
 <cfdump var="#qGetResults.Matwidth1#"> 
  </cfif> --->
	<!--- Mat Size --->
	<!--- Mat --->
	<!--- Individual Photos --->
	<!--- RR 4/30/2015 added and len(trim(qGetResults.Matwidth1)) gt 0) to account for empty mat size --->
	<cfif (val(#qGetResults.Matwidth1#) GT 0) or ((VAL(#qGetResults.default4#) is 0) and len(trim(qGetResults.Matwidth1)) gt 0)>
