...
<CFIF url.id IS "" or not isnumeric(url.id)>
...
<!--- Show Artists Name --->
<div id="Artist_Info" style="text-align:center;margin-left:0;"> <cfif qGetSetup.FirstName is "Nick" and qGetSetup.LastName is "Brandt"><span style="letter-spacing:10px; font-size:16px;">#UCASE(qGetSetup.FirstName)# #UCASE(qGetSetup.LastName)#</span>
<cfelse>#qGetSetup.FirstName# #qGetSetup.LastName#</cfif>
...
<cfif qGetSetup.FirstName is "Nick" and qGetSetup.LastName is "Brandt">
		...
		<a href="http://photoeyegallery.inheritthedust.com"><img src ="http://www.photoeye.com/gallery/images/wasteland-with-elephant-1000px.jpg" width="850" height="405"></a>
		<span style="line-height:38px;"><br /><a href="http://photoeyegallery.inheritthedust.com">VIEW INHERIT THE DUST</a></span> <br />
		<div style="line-height:18px;">photo-eye Gallery - Santa Fe <br />
June 9 - July 23, 2016</div><br />

		<div style="line-height:22px;"><a href="mailto:anne@photoeye.com?Subject=Nick Brandt Inherit the Dust ">Contact Anne Kelly, photo-eye Gallery Director for our <i>Inherit the Dust</i> </a> <br />
		<a href="http://www.photoeye.com/bookstore/citation.cfm?catalog=DS587">Purchase SIGNED COPIES of <i>Inherit the Dust</i> book here</a><br /><br /></div>
		
		<p style="color:##666666;">ADDITIONAL WORK </p>
	</cfif>
...
<!--- Show Nick Brandt Portfolio 14 --->
<cfif qGetSetup.FirstName is "Nickxx" and qGetSetup.LastName is "Brandt">
<a href="http://www.photoeyedev.com/gallery2/viewer.cfm?i=1&id=185363&pid=Portfolio14##0"><img src="http://www.visualserver.com/artists/NickBrandt/Portfolio14/images_large/image1.jpg" width="400"></a><br /><span style="color:##666;">Across the Ravaged Land <br />
photo-eye Gallery - Santa Fe <br />
September 29 - November 30, 2013<br /><br /></span>
</cfif>
