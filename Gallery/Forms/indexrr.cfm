...
<!---   <frame name="MiddleFrame" src="Image1.cfm?id=#url.id#&image=#url.image#&imagePosition=#url.imagePosition#&Door=#url.door#&Portfolio=#url.portfolio#" noresize>
  ...
  <frame name="MiddleFrame" src="Image1rr.cfm?image=#url.imagePosition#&id=#url.id#&imagePosition=#url.imagePosition#&Door=#url.door#&Portfolio=#url.portfolio#" noresize>
</frameset>
      <frame name="RightFrame" scrolling="AUTO" noresize src="Scroll3rr.cfm?id=#qShowcaseArtist.custnumber#&Portfolio=#url.portfolio#">
    </frameset>
