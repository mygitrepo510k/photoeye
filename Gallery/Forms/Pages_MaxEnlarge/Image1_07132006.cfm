...
<cfparam default="1" name="url.imageposition">
...
<!--- Get the previous image --->
	<CFQUERY NAME="qImage_Previous"  DATASOURCE="photoeyecom">
	  SELECT *
	  FROM  GalleryIndividualPhotos where custnumber='#url.id#' and PortfolioName='#url.portfolio#' and showcaseok=1 and notavailable<>4 and ImagePosition<#qImage_Current.imageposition# order by PortfolioName ASC, ImagePosition DESC
	</CFQUERY>
