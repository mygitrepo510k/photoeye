...
<font size="1">
<div align="center"> <img src="/gallery/sharedimages/redlinetoc.gif" width="400" height="1"><FONT FACE="Verdana, Arial, Helvetica, Sans-Serif" size="1" color="#999999"><!--- <a href="../../index.html" TARGET="_parent"> --->
...
<cfif url.door is 4>
	...
	<cfset JLink =''>
	 	<cfif UCASE(qArtist.Gallery) is 'REPRESENTEDARTISTS'>
	 		<cfset JLink = '/gallery/representedArtists/index.cfm'>
	 
	 	<cfelseif UCASE(qArtist.Gallery) is 'PHOTOSHOWCASE'>
	 		<cfif qArtist.Tier is 1>
			
				<cfset JLink = '/gallery/photoshowcase/index.cfm'>
	 ...
	 <cfelseif UCASE(qArtist.Gallery) is 'MAGNUMARTISTS'>
	 	<cfset JLink = '/gallery/MagnumArtists/index.cfm'>
</cfif> 
...
<br><FONT color="SILVER" face="Verdana, Arial, Helvetica, Sans-Serif" size="1"><b><cfoutput>#qArtist.FirstName# #qArtist.LastName# is a #JArtistGallery#</cfoutput> Artist</b></font></a><img src="/Gallery/SharedImages/dot_clear.gif" width="1" height="15">&nbsp;&nbsp;|&nbsp;&nbsp;
...
<cfelse>
  ...
  <cfset Link =''>
	 <cfif UCASE(qArtist.Gallery) is 'REPRESENTEDARTISTS'>
	 	<cfset Link = '<a href="/gallery/representedArtists/index.cfm" target="PEMain" onclick="window.close()">'>
	 
	 <cfelseif UCASE(qArtist.Gallery) is 'PHOTOSHOWCASE'>
	 	<cfif qArtist.Tier is 1>
			
			<cfset Link = '<a href="/gallery/photoshowcase/index.cfm" target="PEMain" onclick="window.close()">'>
		<cfelseif qArtist.Tier is 2>
	 ...
	 <cfelseif UCASE(qArtist.Gallery) is 'MAGNUMARTISTS'>
	 	<cfset Link = '<a href="/gallery/magnumArtists/index.cfm" target="PEMain" onclick="window.close()">'>
     </cfif>	 
...
<cfoutput>#Link#</cfoutput><FONT color="SILVER" face="Verdana, Arial, Helvetica, Sans-Serif" size="1" onMouseover="this.color='Red';" onMouseout="this.color='SILVER';"  style="TEXT-DECORATION: none"><b><cfoutput>#ArtistGallery#</cfoutput> 
  Home</b></font></a><img src="/Gallery/SharedImages/dot_clear.gif" width="1" height="15">&nbsp;&nbsp;|&nbsp;&nbsp; 
  <!--- <a href="../../../indexnew.html" Target=_top> --->
  <a href="/gallery/index.cfm" TARGET="PEMain" onClick="window.close()"><FONT color="SILVER" face="Verdana, Arial, Helvetica, Sans-Serif" size="1" onMouseover="this.color='Red';" onMouseout="this.color='SILVER';"  style="TEXT-DECORATION: none"><b>All 
  Galleries Home </b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp; 
  <!--- 02/17/05 ArtistGallery has the registered trademark if Showcase Gallery Artist. this symbol did not show properly on the Subject line. So we are redefining the variable here --->
<cfif UCASE(qArtist.Gallery) is 'PHOTOSHOWCASE'>
	<cfset ArtistGallery = "Photographer's Showcase">
</cfif>
<a href="mailto:photoshowcase@photoeye.com?Subject=<cfoutput>#qArtist.FirstName# #qArtist.LastName# Inquiry - #ArtistGallery#</cfoutput> Artist"><FONT color="SILVER" face="Verdana, Arial, Helvetica, Sans-Serif" size="1" onMouseover="this.color='Red';" onMouseout="this.color='SILVER';"  style="TEXT-DECORATION: none"><b>E-mail</b></font></a><br>
  </font>
