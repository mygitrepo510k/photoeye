...
<CFQUERY NAME="qShowcaseGalleryIndividualPhotos"  DATASOURCE="photoeyecom">
  SELECT *
  FROM GalleryIndividualPhotos where custnumber=#url.id# AND IMAGENUMBER='#url.image#' AND PORTFOLIONAME='#url.portfolio#' and NOT (notavailable=4 and imagenumber>1)
</CFQUERY>
...
<BODY text="##999999" vlink="##999999" link="##999999" alink="Red" bgcolor="###Background#" topmargin="1" onLoad="CheckCookie('BestCookieSP')"> 
        ...
        <td height="80%"> 
			...
			<tr valign="bottom" height="165" align="left"> 
			  ...
			  <td width="65%" height="*" rowspan="2" valign="top" align="right">
			    <div align="right"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#url.image#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','630','490','no');"><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
...
<input type="hidden" name="Title" value="#qGetDetails.Title2x#">
				...
				<cfif #qShowcasePortfolio.Backgroundcolor# is "333333">
					...
					<cfelseif (qShowcaseGalleryIndividualPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 0) or (qShowcaseGalleryDefaultPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1)>
  				   ...
  				   <img src="../SharedImages/dot_clear.gif" width="1" height="20" alt="" border="0"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#url.image#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','600','490','no');"><img src="../sharedimages/enlargeGray.gif" width="90" height="15" alt="" border="0" name="img2"></a><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
                 <cfelse>
					<cfif (qShowcaseGalleryIndividualPhotos.NotAvailable is 0 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 0) or (qShowcaseGalleryDefaultPhotos.NotAvailable is 0 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1)>
					...
					<cfelseif (qShowcaseGalleryIndividualPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 0) or (qShowcaseGalleryDefaultPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1)>
					 <font face="verdana, arial, helvetica, sans-serif" size="1" color="Yellow" style="TEXT-DECORATION: none">Not for Sale</font><br>
						   ...
						   <img src="../SharedImages/dot_clear.gif" width="1" height="20" alt="" border="0"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#url.image#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','600','490','no');"><img src="../sharedimages/enlarge.gif" width="90" height="15" alt="" border="0" name="img2"></a><!---  image=#image#&id=#url.id# ---><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
				 </cfif>
                </p>
              </td>
            </tr>
