...
<cfset JArtistGallery =''>
	 ...
	 <cfelseif UCASE(qArtist.Gallery) is 'PHOTOSHOWCASE'>
	 	<cfif qArtist.Tier is 1>
			...
			<cfset JArtistGallery =  "Photographer's Showcase Gallery">
		<cfelseif qArtist.Tier is 2>
...
<cfset ArtistGallery =''>
	 ...
	 <cfelseif UCASE(qArtist.Gallery) is 'PHOTOSHOWCASE'>
	 	<cfif qArtist.Tier is 1>
			...
			<cfset ArtistGallery = "Photographer's Showcase Gallery">
		<cfelseif qArtist.Tier is 2>
...
<br><cfoutput>#Link#</cfoutput><FONT color="SILVER" face="Verdana, Arial, Helvetica, Sans-Serif" size="1" onMouseover="this.color='Red';" onMouseout="this.color='SILVER';"  style="TEXT-DECORATION: none"><b><cfoutput>#ArtistGallery#</cfoutput> Home</b></font></a><img src="../SharedImages/dot_clear.gif" width="1" height="15">&nbsp;&nbsp;|&nbsp;&nbsp;<!--- <a href="../../../indexnew.html" Target=_top> --->

<a href="http://www.photoeye.com/gallery/index.cfm" TARGET="_top"><FONT color="SILVER" face="Verdana, Arial, Helvetica, Sans-Serif" size="1" onMouseover="this.color='Red';" onMouseout="this.color='SILVER';"  style="TEXT-DECORATION: none"><b>All Galleries
  Home </b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;
