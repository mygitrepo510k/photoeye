...
<FORM ACTION="javascript:popUp('../../templates/AddtoCartGalleriesNew.cfm?userid=#Cookie.UserIdNumber#&NumCopies=1&Binding=Photography&Listprice=#qGetDetails.Soft_price#&SalePrice=0&RecordID=#qGetDetails.recordID#&Catnum=#qGetDetails.Catalog#&ArtistF=#ArtistF#&ArtistL=#ArtistL#&Showcase=1','MyWindowOrder','600','490');" METHOD="POST">
        ...
        <td height="80%"> 
			...
			<tr valign="bottom" height="165" align="left"> 
			  ...
			  <td width="65%" height="*" rowspan="2" valign="top" align="right">
			    <div align="right"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#qShowcaseGalleryIndividualPhotos.imagenumber#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','630','490','no');"><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
				<img src="../#qShowcaseArtist.Gallery#/Artists/#qShowcaseArtist.Subdirectory#/#Portfolio#/Images_Medium/Image#qShowcaseGalleryIndividualPhotos.imageNUMBER#.jpg" alt="" border="0"></a></div>
              </td>
				 ...
				 #qShowcaseGalleryDefaultPhotos.portfolioName#</font><br><br>
				  ...
				  <!--- Portfolio Introduction --->
					  <cfif len(#qShowcasePortfolio.portfoliointro#) GT 0 and #qShowcaseGalleryIndividualPhotos.imagenumber# is 1 and #len(qShowcaseGalleryDefaultPhotos.portfolioName)# GT 0>
						 <A HREF="javascript:popUp('PortfolioIntro.cfm?id=#url.id#&IMAGENUMBER=#url.image#&PORTFOLIO=#url.portfolio#','myWindowEnlarge',630,460);">
...
<!--- 				 <cfif #qShowcaseGalleryIndividualPhotos.Editioned1# is 1 and #len(qShowcaseGalleryIndividualPhotos.EditionNo1)# GT 0 and #len(qShowcaseGalleryIndividualPhotos.EditionSz1)# GT 0>	#qShowcaseGalleryIndividualPhotos.EditionNo1#/#qShowcaseGalleryIndividualPhotos.EditionSz1#<br> 
                 ...
                 <cfif #qShowcaseGalleryIndividualPhotos.price1# GT 0 and  qShowcaseGalleryIndividualPhotos.NotAvailable is 0 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1>
...
<input type="hidden" name="Title" value="#qGetDetails.Title2x#">
				...
				<cfif #qShowcasePortfolio.Backgroundcolor# is "333333">
					...
					<cfelseif (qShowcaseGalleryIndividualPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 0) or (qShowcaseGalleryDefaultPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1)>
  				   ...
  				   <img src="../SharedImages/dot_clear.gif" width="1" height="20" alt="" border="0"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#qShowcaseGalleryIndividualPhotos.imagenumber#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','600','490','no');"><img src="../sharedimages/enlargeGray.gif" width="90" height="15" alt="" border="0" name="img2"></a><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
                 <cfelse>
					<cfif (qShowcaseGalleryIndividualPhotos.NotAvailable is 0 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 0) or (qShowcaseGalleryDefaultPhotos.NotAvailable is 0 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1)>
					...
					<cfelseif (qShowcaseGalleryIndividualPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 0) or (qShowcaseGalleryDefaultPhotos.NotAvailable is 3 and #qShowcaseGalleryIndividualPhotos.defaultNFS# is 1)>
					 <font face="verdana, arial, helvetica, sans-serif" size="1" color="Yellow" style="TEXT-DECORATION: none">Not for Sale</font><br>
						   ...
						   <img src="../SharedImages/dot_clear.gif" width="1" height="20" alt="" border="0"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#qShowcaseGalleryIndividualPhotos.imagenumber#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','600','490','no');"><img src="../sharedimages/enlarge.gif" width="90" height="15" alt="" border="0" name="img2"></a><!---  image=#image#&id=#url.id# ---><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
				 </cfif>
                </p>
              </td>
            </tr>
