...
P O R T F O L I O
  ...
  <img src="SharedImages/dot_clear.gif" width="1" height="1">
	...
	<cfloop query="qGetPortfolios" startrow="1" endrow="#MaxPortfolios#">
		...
		<CFIF qGetDefaultPhotos.RECORDCOUNT GT 0>
		...
		<a href="index.cfm?id=#url.id#&image=1&imagePosition=1&Door=#url.door#&Portfolio=Portfolio#PortfolioNo#&Gallery=#url.gallery#&Page=#xpage#"  target="_top">

<img src ="../#qGetSetup.Gallery#/Artists/#qGetSetup.Subdirectory#/Portfolio#PortfolioNo#/Images_Search/image1.jpg" border="0"></a>
