...
<FORM ACTION="../../templates/AddtoCartGalleriesAmazon.cfm?userid=#Cookie.UserIdNumber#&NumCopies=1&Binding=Photography&Listprice=#qGetDetails.Soft_price#&SalePrice=0&RecordID=#qGetDetails.recordID#&Catnum=#qGetDetails.Catalog#&ArtistF=#ArtistF#&ArtistL=#ArtistL#&Showcase=1" METHOD="POST" target="_top">
...
<img src="../../artists/#qShowcaseArtist.Subdirectory#/#qShowcaseGalleryIndividualPhotos.PortfolioName#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#xAlt#"></a></div>
<!--- End ImageSizer --->
  ...
  <a href="javascript:popUp('Pages_MaxEnlarge/image1.cfm?imageposition=#image#&id=#url.id#&Portfolio=#url.portfolio#','myWindowEnlarge',1012,710,'yes','no');"><img src="../../artists/#qShowcaseArtist.Subdirectory#/#qShowcaseGalleryIndividualPhotos.PortfolioName#/Images_Large/#xImage#_H#xHeight#xW#xWidth#.#xImageFormat#" border="0" ALT="#xAlt#"></a>
...
<!--- 				 <cfif #qShowcaseGalleryIndividualPhotos.Editioned1# is 1 and #len(qShowcaseGalleryIndividualPhotos.EditionNo1)# GT 0 and #len(qShowcaseGalleryIndividualPhotos.EditionSz1)# GT 0>	#qShowcaseGalleryIndividualPhotos.EditionNo1#/#qShowcaseGalleryIndividualPhotos.EditionSz1#<br> 
	...
	<!--- 		 <td width="*" height="*" valign="top">
            ...
            <tr valign="middle" height="55"> <!--- 165 ---> 
