...
<cfoutput>
<body bgcolor="###Background#" link="##FFFF99" topmargin=0 leftmargin=0 text="Silver" vlink="Silver" alink="Red"></cfoutput>
<cfoutput>
...
<cfset counter=1>  
	...
	<cfif counter is 1>	
				<font size=1 face="verdana, arial, helvetica, sans-serif" color="##FFFF99">
			<br>Jury's Selected Images</font><br><br>
		</cfif> <a href="Image1.cfm?image=#qShowcaseGalleryIndividualPhotos.imagenumber#&id=#url.id#&Portfolio=#url.portfolio#" target="MiddleFrame"> <img src="../#qShowcaseArtist.Gallery#/Artists/#qShowcaseArtist.Subdirectory#/#Portfolio#/Images_Thumbs/image#qShowcaseGalleryIndividualPhotos.imagenumber#.jpg"  alt="" border="0" ></a>
</td></tr></table>
