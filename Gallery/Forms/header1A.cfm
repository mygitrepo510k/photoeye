...
<table width="470" border="0" cellspacing="0" align="center">
  <tr align="center" valign="middle" bgcolor="###BackgroundHeader#"> 
    <td  width="470" height="55"><font face="Verdana, Arial, Helvetica, sans-serif" color="##FFFF99" size="2"><b>#qGetShowcaseDefaultInfo.PortfolioName#</b><br><img src="../sharedimages/redlinetoc.gif" width="300" height=1 alt="" border="0"><img height=3 src="../../dot_clear.gif" width=1>
      </font></td>
...
<table width="470" border="0" cellspacing="0" align="center">
  <tr align="center" valign="middle" bgcolor="###BackgroundHeader#"> 
    <td  width="470" height="55"><font face="Verdana, Arial, Helvetica, sans-serif" color="##CCCCCC" size="2"><font color="##CCCCCC"><b>#qShowcaseArtist.FirstName# #qShowcaseArtist.LastName#</b><font size="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#qShowcaseArtist.Nationality#<cfif #len(qShowcaseArtist.Birth)# GT 0>, b.#qShowcaseArtist.Birth#</cfif><br><img src="../sharedimages/redlinetoc.gif" width="300" height=1 alt="" border="0"><img height=3 src="../../dot_clear.gif" width=1>
      </font></font></font></td>
  ...
  <table width="470" border="0" cellspacing="0" align="center" height="29" cellpadding="0">
    <tr align="right" valign="top" bgcolor="###Background#"> 
      <td colspan="4" align="right" height="31"> 
        <img height=2 src="../../dot_clear.gif" width=1><div align="center">
...
<CFELSE>	
	<A href="/gallery/forms2/homepage.cfm?id=#url.id#&door=#url.door#&Gallery=#url.gallery#&Portfolio=1&Page=#URL.Page#" target="PEMain" onclick="window.close()"> 
</CFIF>
...
<cfelse>
	...
	<A href="../../templates/msearchshowcasePowerSearch.cfm?Gallery=0&keyword=#keyword#*" target="_top"> 
	
	<cfelseif url.door is 80>
		<cfset keyword= REPLACE(#URL.KEYWORD#," ","%20","All")>  
	<A href="../../templates/msearchshowcasePowerSearch.cfm?Include=1&Gallery=0&Keyword=#Keyword#" target="_top"> 	
	
	<cfelseif url.door is 81>
		<cfset keyword= REPLACE(#URL.KEYWORD#," ","%20","All")>  
	<A href="../../templates/msearchshowcasePowerSearch.cfm?Include=1&Gallery=1&Keyword=#Keyword#" target="_top"> 	
	<cfelseif url.door is 8>
		<cfset keyword= REPLACE(#URL.KEYWORD#," ","%20","All")>  	
		<A href="../../templates/msearchshowcasePowerSearch.cfm?Gallery=#url.gallery#&keyword=#keyword#*" 		target="_top">
	...
	<cfelseif url.door is 82>
		<cfset keyword= REPLACE(#URL.KEYWORD#," ","%20","All")>  
	<A href="../../templates/msearchshowcasePowerSearch.cfm?Include=1&Gallery=2&Keyword=#Keyword#" target="_top"> 	
	
	<cfelseif url.door is 83>
		<cfset keyword= REPLACE(#URL.KEYWORD#," ","%20","All")>  
	<A href="../../templates/msearchshowcasePowerSearch.cfm?Include=1&Gallery=3&Keyword=#Keyword#" target="_top"> 			
