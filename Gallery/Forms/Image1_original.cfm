...
<!--- End ImageSizer --->
			 ...
			 <cfelse>
			  ...
			  <td width="100%" rowspan="2" valign="top" align="center">
			    <div align="center"><a href="javascript:popUp('pages_enlarge/Image1.cfm?image=#qShowcaseGalleryIndividualPhotos.imagenumber#&id=#url.id#&Portfolio=#url.portfolio#','MyWindowShowcase','630','490','no');"><!--- #qShowcaseGalleryIndividualPhotos.imageposition# --->
