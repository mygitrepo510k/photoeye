...
<!--- 				 <cfif len(trim(#qShowcaseGalleryIndividualPhotos.yearprod#)) GT 0 and RIGHT(#qShowcaseGalleryIndividualPhotos.title#,4) is NOT #qShowcaseGalleryIndividualPhotos.yearprod#>
				...
				<b> 
                 ...
                 <cfif val(#qShowcaseGalleryIndividualPhotos.width1#) GT 0>
...
Edition of #qShowcaseGalleryIndividualPhotos.EditionSz1#<br> 
				 <cfelseif #qShowcaseGalleryIndividualPhotos.Default5# is 1 and  #qShowcaseGalleryDefaultPhotos.Editioned1# is 1 and (#len(trim(qShowcaseGalleryDefaultPhotos.EditionNo1))# is 0 #qShowcaseGalleryIndividualPhotos.EditionNo1# is 0))>		Edition of #qShowcaseGalleryDefaultPhotos.EditionSz1#<br> 
