...
<CFQUERY NAME="qGetImagePosition"
         DATASOURCE="photoeyecom">

SELECT     TOP 1 GalleryIndividualPhotos.ImagePosition, GalleryIndividualPhotos.ImageNumber, GalleryPortfolio.Custnumber, 
                      GalleryPortfolio.SubDirectory
FROM         GalleryPortfolio INNER JOIN
                      GalleryIndividualPhotos ON GalleryPortfolio.Custnumber = GalleryIndividualPhotos.Custnumber
