...
<TABLE WIDTH="700" height="50"><TR>
      <td align="center"> <FONT FACE="'Trebuchet MS', Verdana, Arial, Helvetica, sans-serif" class="text">photo-eye 
  ...
  <TABLE CELLPADDING="5" ALIGN="CENTER" width="700">
    <TR>
      <TD VALIGN="TOP" width="148"> 
	    <cfset xImage = "2006-FALL-cover-3D.jpg"> <cfset xPath = "..\Booklist\2006_Fall"> 
        <CFSET xHeight = "280"> <CFSET xWidth = "200"> <CFSET xALT="#Season# 2006 Booklist"> 
		...
		<cfset xImage = "2006-SUMMER-3D-365-h.jpg"> <cfset xPath = "..\Booklist\2006_Summer"> 
        <CFSET xHeight = "280"> <CFSET xWidth = "200"> <CFSET xALT="#Season# 2006 Booklist"> 
        <cfinclude template="../templates/imagesizer.cfm"> <CFOUTPUT> <A HREF="../templates/mShowDetailsbyCat.cfm?Catalog=pe027"><img src="../_cache/#imagecr.filename#" height='#imagecr.height#' width='#imagecr.width#' border="0" ALT='#xAlt#' Align='center' style="border-color:Silver" vspace="5"></A> 
        </CFOUTPUT> <cfset xImage = "pe026b.jpg"> <cfset xPath = "..\img\BigIllus"> 
        <CFSET xHeight = "280"> <CFSET xWidth = "200"> <CFSET xALT="#Season# 2006 Booklist"> 
        <cfinclude template="../templates/imagesizer.cfm"> <CFOUTPUT> <A HREF="../templates/mShowDetailsbyCat.cfm?Catalog=pe026"><img src="../_cache/#imagecr.filename#" height='#imagecr.height#' width='#imagecr.width#' border="0" ALT='#xAlt#' Align='center' style="border-color:Silver" vspace="5"></A> 
        </CFOUTPUT> <cfset xImage = "pe025b.jpg"> <cfset xPath = "..\img\BigIllus"> 
        <CFSET xHeight = "280"> <CFSET xWidth = "200"> <CFSET xALT="#Season# 2006 Booklist"> 
        <cfinclude template="../templates/imagesizer.cfm"> <CFOUTPUT> <A HREF="../templates/mShowDetailsbyCat.cfm?Catalog=pe025"><img src="../_cache/#imagecr.filename#" height='#imagecr.height#' width='#imagecr.width#' border="0" ALT='#xAlt#' Align='center' style="border-color:Silver" vspace="5"></A> 
        </CFOUTPUT> <cfset xImage = "pe024b.jpg"> <cfset xPath = "..\img\BigIllus"> 
        <CFSET xHeight = "280"> <CFSET xWidth = "200"> <CFSET xALT="#Season# 2006 Booklist"> 
        <cfinclude template="../templates/imagesizer.cfm"> <CFOUTPUT> <A HREF="../templates/mShowDetailsbyCat.cfm?Catalog=pe024"><img src="../_cache/#imagecr.filename#" height='#imagecr.height#' width='#imagecr.width#' border="0" ALT='#xAlt#' Align='center' style="border-color:Silver" vspace="5"></A> 
        </CFOUTPUT> <cfset xImage = "pe023b.jpg"> <cfset xPath = "..\img\BigIllus"> 
        <CFSET xHeight = "280"> <CFSET xWidth = "200"> <CFSET xALT="#Season# 2006 Booklist"> 
        <cfinclude template="../templates/imagesizer.cfm"> <CFOUTPUT> <A HREF="../templates/mShowDetailsbyCat.cfm?Catalog=pe023"><img src="../_cache/#imagecr.filename#" height='#imagecr.height#' width='#imagecr.width#' border="0" ALT='#xAlt#' Align='center' style="border-color:Silver" vspace="5"></A> 
        </CFOUTPUT> </TD>
      <td width="10">&nbsp;</td>
