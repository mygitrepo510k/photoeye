      ...
      <td height="136" align="right" valign="top"> 
        <div align="center">
          ...
          <p><font color="#333333" size="2" face="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif"><strong>In 
            ...
            the best books being published today. The Survey forms the heart of 
            the <em>Booklist.</em><br>
            <br />
            CONTRIBUTING WRITERS: </strong></font> <font color="#333333" size="2" face="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif"><strong>DEBRA 
            KLOMP CHING, MARY GOODWIN, PHIL HARRIS, PAUL KRANZLER, LARISSA LECLAIR, 
            HANNAH NEWBURN, ALAN RAPP, and GEORGE SLADE.</strong></font></p>
        </div></TD>
  </TR></TABLE>
...
<TR><TD ALIGN="CENTER"><FONT FACE="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif" class="text">#xAuthor#</FONT></TD></TR></TABLE></TD>
	  ...
	  <p><br><br>
        <br>
        Read this entire article by <a href="http://www.photoeye.com/templates/mShowDetailsbycat.cfm?Catalog=PE033"> 
