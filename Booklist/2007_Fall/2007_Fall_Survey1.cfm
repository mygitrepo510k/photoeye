      ...
      <td height="136" align="right" valign="top"> 
        <div align="center">
          ...
          <p><font color="#333333" size="2" face="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif"><strong>In 
            ...
            <br />
            CONTRIBUTING WRITERS: </strong></font><br>
            <font color="#333333" size="2" face="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif"><strong>DEBRA 
            KLOMP CHING, MARY GOODWIN, PHIL HARRIS, LARISSA LECLAIR,<br>
            </strong></font><font color="#333333" size="2" face="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif"><strong>ANTHONY 
            LASALA, EUGENIA PARRY, and JOHN PILSON</strong></font></p>
          </div></TD>
  </TR></TABLE>
...
<TR><TD ALIGN="CENTER"><FONT FACE="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif" class="text">#xAuthor#</FONT></TD></TR></TABLE></TD>
	  ...
	  <p><br><br>
        <br>
        Read this entire article by <a href="http://www.photoeye.com/templates/mShowDetailsbycat.cfm?Catalog=PE032"> 
