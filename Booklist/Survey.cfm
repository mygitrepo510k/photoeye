...
<select size="1" name="percentage_books_photoeye">
			...
			<td style="padding-right: 5px"></td>
				<td class="standard9"><textarea name="earn_more_business" cols="60" rows="5" class="standard9"></textarea></td>
			...
			<tr>
				...
				<td valign="top" style="padding-right: 10px; padding-bottom:1px" class="standard9">Are you currently a Booklist magazine subscriber?</td>
			</tr>
			<tr>
				<td valign="top" style="padding-right: 5px; padding-bottom:10px" class="standard9">&nbsp;</td>
				<td valign="top" style="padding-right: 10px; padding-bottom:10px" class="standard9">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td style="padding-right: 5px"><input type="radio" value="1" name="subscriber"></td>
						<td class="standard9">Yes</td>
					</tr>
					<tr>
						<td style="padding-right: 5px"><input type="radio" value="0" name="subscriber"></td>
						<td class="standard9">No</td>
					</tr>
				</table>
				</td>
			...
			<tr>
				<td valign="top" style="padding-right: 3px; padding-bottom:1px" class="standard9">14b) </td>
				<td valign="top" style="padding-right: 10px; padding-bottom:1px" class="standard9">Do you ever purchase books as a result of these ads?</td>
			</tr>
			<tr>
				<td valign="top" style="padding-right: 5px; padding-bottom:10px" class="standard9">&nbsp;</td>
				<td valign="top" style="padding-right: 10px; padding-bottom:10px" class="standard9">
			...
			<tr>
				<td valign="top" style="padding-right: 3px; padding-bottom:1px" class="standard9">15)</td>
...
<CFCASE value = "SurveyAction">
	...
	<cfquery name="qSurveyCreate" datasource="Photoeyecom">
		...
		<cfif IsDefined("form.subscriber")>
			subscriber,
		</cfif>		
		TimeCreated)
...
<b>Are you now a Booklist subscriber?:</b>  <cfif IsDefined("form.subscriber")>#YesNoFormat(form.subscriber)#</cfif><br><br>
<b>Do you read the ads in the Booklist?:</b> <cfif IsDefined("form.readadds")>#YesNoFormat(form.readadds)#</cfif><br><br>
<b>Do you ever purchase books as a result of these ads?:</b> <cfif IsDefined("form.actadds")>#YesNoFormat(form.actadds)#</cfif><br><br>
