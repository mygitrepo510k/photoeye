 ...
 <br /><br />
    ...
    <td height="50" align="right" valign="top">
      <div align="center">
          ...
          <p><font color="#333333" size="2" face="'Trebuchet MS',  verdana, Arial, Helvetica, sans-serif">In 
            each issue we commission writers from across the country to review 
            the best books <br>
            being published today.The Survey forms the heart of the Booklist. 
            <br />
            BY Julie Anand, Leah Bendavid-Val, David Carl, Zane Fischer, Phil 
            Harris, Mark Hillringhouse, <br>
            Larissa Leclair, Alan Rapp, Mary Anne Redding, and Sheila Wilson.</font></p>
          </div></TD>
  </TR></TABLE>
