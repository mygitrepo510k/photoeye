...
<META NAME="KEYWORDS" CONTENT="photography bookstore photo-eye photoeye photography photo book books bookstore book store gallery art nudes erotic out-of-print out of print op o.p. Mona Kuhn Julie Blackmon  Nick Brandt -jock sturges sally mann paul caponigro walter chappell ted kuykendall debbie fleming caffery james ware pitts mark klett terri weifenbach david gibson edward ranney laurent millet Photographer's Showcase, Magnum Photos Collectors' Prints, photo-eye Gallery of Represented Artists">
    <TITLE>
        photo-eye | Photography Magazine, Bookstore, Gallery, Auctions, Guide, Visualserver, Newsletters
    </TITLE>
...
function swapbglogo(towhat){
	...
	if (towhat == "bookstore"){
		bglogo.style.background = "url(images/photoeye_logo_books.gif) no-repeat center" ;
	}
	else {
		if (towhat == "auctions"){
			bglogo.style.background = "url(images/photoeye_logo_auctions.gif) no-repeat center" ;	
		}
		else {
			if (towhat == "magazine"){
				bglogo.style.background = "url(images/photoeye_logo_magazine.gif) no-repeat center" ;				
			}
			bglogo.style.background = "url(images/photoeye_logo.gif) no-repeat center" ;
		}	
	}	
}
--->
function swapbglogo(towhat){
	...
	newbgpathb = ".gif) no-repeat center";
...
<link rel="stylesheet" type="text/css" href="css/homepagev2.css" />
...
<CFQUERY NAME="qGetPortfolio" DATASOURCE="photoeyecom">
	...
	WHERE (P.ImgQty > 0)and (I.ShowcaseOK = 1) AND (P.ShowcaseOK = 1) and I.ImagePosition > 0 and p.custnumber<>185363
...
<CFQUERY NAME="qGetPortfolioImageCount" DATASOURCE="photoeyecom">
	...
	WHERE (I.ShowcaseOK = 1) and I.ImagePosition > 0 and i.custnumber=#qGetPortfolio.custnumber# and PortfolioName = '#qGetPortfolio.PortfolioName#'
</CFQUERY>



<font color="white"><cfoutput>#qGetPortfolioImageCount.xqty#</cfoutput></font>
<CFSET ImageNumber = 1>    
...
<CFQUERY NAME="qGetPhoto" DATASOURCE="photoeyecom">
	SELECT DISTINCT 
	TOP 1 G.Subdirectory AS SubDirectory, G.FirstName AS Firstname, P.ImgQty AS ImageQTy, G.LastName AS Lastname, G.Gallery AS Gallery, G.Custnumber AS Custnumber, P.SubDirectory AS Portfolio, D.GeneralRandomNo, CONVERT(char(20), P.ExhibitionOpened, 102) AS Opened, I.ImageNumber AS Imagenumber, I.ShowcaseOK, I.ImagePosition AS IMAGEPOSITION, D.PortfolioName, I.Title as Title, NewID() as RandomOrder
	FROM GallerySetup G 
	INNER JOIN GalleryPortfolio P ON G.Custnumber = P.Custnumber 
	INNER JOIN GalleryDefaultPhotos D ON P.Custnumber = D.Custnumber 
	INNER JOIN GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
	WHERE (P.ImgQty > 0) AND (I.ImagePosition = #xImgPosition#) and (I.ShowcaseOK = 1) AND (P.ShowcaseOK = 1) and g.custnumber=#qGetPortfolio.Custnumber# 
...
<CFIF qGetPhoto.recordcount is 0> 
	<CFQUERY NAME="qGetPhoto" DATASOURCE="photoeyecom">
		SELECT DISTINCT 
		TOP 1 G.Subdirectory AS SubDirectory, G.FirstName AS Firstname, P.ImgQty AS ImageQTy, G.LastName AS Lastname, G.Gallery AS Gallery, G.Custnumber AS Custnumber, P.SubDirectory AS Portfolio, D.GeneralRandomNo, CONVERT(char(20), P.ExhibitionOpened, 102) AS Expr1, I.ImageNumber AS Imagenumber, I.ShowcaseOK, I.ImagePosition AS IMAGEPOSITION, D.PortfolioName, I.Title as Title, NewID() as RandomOrder
		FROM GallerySetup G 
		INNER JOIN GalleryPortfolio P ON G.Custnumber = P.Custnumber 
		INNER JOIN GalleryDefaultPhotos D ON P.Custnumber = D.Custnumber 
		INNER JOIN GalleryIndividualPhotos I ON P.SubDirectory = I.PortfolioName AND I.Custnumber = G.Custnumber
		WHERE (P.ImgQty > 0) AND (I.ImagePosition = #xImgPosition#) and (I.ShowcaseOK = 1)  AND (P.ShowcaseOK = 1) 
...
<cfloop condition="auctionHasImage EQ 0">
	<CFQUERY NAME="qGetAuctionAdmin"  DATASOURCE="photoeyecom">
		SELECT *
		FROM AuctionAdmin
		WHERE EndAnnounced = 0 
		AND Publish=1 and AuctionID <> 6
	</CFQUERY>
...
<div id="IEroot">  
<![endif]-->
<div class="Home_Contain_All" id="BG" style="background: url(images/photoeye_logo.gif) no-repeat center;margin-top:<!--- this is the distance from the top of the bookstore item, to the bottom of the browser window --->#xTopMargin#px ;">
...
<cfif xrecordfound is 1>
		...
		<div class="Home_Division" id="gallery">
			<!--- onmouseout="swapbglogo('back')" --->>
				...
				<cfset xImage = "Image#xImageNumber#.jpg">
	...
	<!--- Auctions --->
		...
		<div class="Home_Division" id="magazine">
			<!---<!--- onmouseout="swapbglogo('back')" ---> --->>
				...
				<img src="images/home_mag_07_05.jpg" height="90" width="190"/>
			</a>
		</div>
...
<div style="width: 900px; clear: both; margin: 25px auto;">
	...
	<font class="Home_Name" style="color:white;">Sign up for our Email Newsletters: </font>
...
<div id="imagepreloader">
	<img src="images/photoeye_logo_bookstore.gif" />
	<img src="images/photoeye_logo_gallery.gif" />
	<img src="images/photoeye_logo_magazine.gif" />
	<img src="images/photoeye_logo_newsletters.gif" />
	<img src="images/photoeye_logo_guide.gif" />
	<img src="images/photoeye_logo_visualserver.gif" />
	<img src="images/photoeye_logo_auctions.gif" />
