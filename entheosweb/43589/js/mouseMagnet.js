$(document).ready(function(){	
	...
	$('.bubbles>div>span').live('mouseenter',function (e){
	    $(this).stop(true);
	...
	$('.bubbles>div>span').live('mousemove',function (e){
	...
	$('.bubbles>div>span').live('mouseleave',function (e,x){
	    var time = 150;
        leftAt_x = (e.pageX - mouseEnteredAt_x)/dampener;
		...
		$(this).animate({left: 0, top: 0},time);
	});
 });