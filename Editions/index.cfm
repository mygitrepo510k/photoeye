...
<cfif CGI.SERVER_NAME CONTAINS "photoeye.com"> 
<cflocation url="http://www.photoeyeeditions.com/Index.cfm#IIF(len(CGI.PATH_INFO) AND CGI.PATH_INFO NEQ '/editions/index.cfm',DE(CGI.PATH_INFO),DE('/page.index'))#" addToken="no"/>
</cfif>
</cfsilent>
<cfif StructKeyExists(URL,"developer2834927710ujdk38")>
	<cfdump var="#CGI#" />
	<cfabort />
</cfif>
...
<cfelse>
<div style="margin: 50 auto; text-align:center;">photo-eye Editions is undergoing maintenance, and will resume operation at 5:30pm EST.</div>
</cfif>
--->
