...
<cfinclude template="Includes/dsp_Auctions_confirmbid_content.cfm">
...
<CFIF xLoggedIn is 0>
	...
	<CFELSEIF IsDefined("url.ID")>
		<CFLOCATION URL="../templates/newpasswordenter.cfm?Auction=1&ReturnToAuctionID=#url.ID#">
	<CFELSE>
		<CFLOCATION URL="../templates/newpasswordenter.cfm?Auction=1">
	</CFIF>
</CFIF>
...
<cfquery name="qGetCreditCards" datasource="photoeyecom">
	...
	WHERE custnumber=#Session.AcctID# and exp<>'' and CardDefault = 1
</cfquery>
...
<!--- "Oops!" Title for Error Messages --->
<CFSET xTitle = '
<table width="800" align="center" cellpadding="0" cellspacing="0"><tr><td align="center" class="Header"><font color="Black" face="Times, Times-Roman, serif" size="5">O</font><font color="Black" face="Times, Times-Roman, serif" size="4">OPS!</FONT></td></tr></table>'>

<CFINCLUDE TEMPLATE="AuctionTime.cfm">
...
<CFIF xTime lte 0>
	...
	<BR><BR>
	Please <b><a href="Auction.cfm?ID=#xID#">return</a></b> to the auction to see who won.</font></cfoutput>
...
<br>
	...
	<cfoutput>Your new <A HREF="../auctions/MaximumBid.cfm">Maximum Bid</A> of <font color="Maroon"><b>$#trim(NumberFormat(form.bid,"99,999"))#</b></font>
...
<br>
	...
	<cfoutput>Your desired new <A HREF="../auctions/MaximumBid.cfm">Maximum Bid</A> of <font color="Maroon"><b>$#trim(NumberFormat(form.bid,"99,999"))#</b></font> must be greater than your current maximum bid of <font color="Maroon"><b>$#trim(NumberFormat(xLastHighBid,"99,999"))#.</b></font><br>
<br>
Please <b><a href="javascript:history.back()">return</a></b> to the auction to continue bidding.</font></cfoutput>>
...
<br>
<form action="../Auctions/AuctionConfirmBid.cfm" method="post" name="SubmitBid" id="SubmitBid">
	<input type="hidden" name="AuctionID" value="#form.AuctionID#">
	<input type="hidden" name="Bid" value="#xRoundedBid#">
	<input type="Submit" name="Submit" value="Place a bid for $#trim(NumberFormat(xRoundedBid,"99,999"))#">&nbsp;&nbsp;<input type="button" value="Cancel" onClick="javascript:history.back()">
</FORM>
	</CFOUTPUT>
...
<CFELSE>
	...
	Please confirm your new <A HREF="../auctions/MaximumBid.cfm">Maximum Bid</A> of <b>$#trim(NumberFormat(form.bid,"99,999"))#</b>.
	</FONT>
	</CFOUTPUT>
	<BR><BR>
	<input type="submit" name="SubmitBid" value="Commit Bid">&nbsp;&nbsp;<input type="button" value="Cancel" onClick="javascript:history.back()">
	</form>
</CFIF>
