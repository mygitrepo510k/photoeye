		...
		<tr>
			<td style="padding-top:10px;padding-bottom:5px" width="10%" nowrap>
				...
				<cfif thisPage - 2 GT 1>
					<a href="#cgi.script_name#?st=1&nPP=#numPerPage#&view=#url.view#" title="View First Page" style="text-decoration:underline">&laquo; First</a> ...
				</cfif>
				...
				<cfloop from="#ceiling(thisPage - 2)#" to="#ceiling(thisPage + 2)#" index="i">
					...
					<cfif curPage GT 0 AND curPage LTE numPages>
						<cfif thisPage EQ curPage>
							<b>[#curPage#]</b>
						<cfelse>
							<a href="#cgi.script_name#?st=#curStartRow#&nPP=#numPerPage#&view=#url.view#" title="View Items #curStartRow# - #curEndRow#" style="text-decoration:underline">#curPage#</a> 
						</cfif>
					</cfif>
				</cfloop>
				<!--- display "last page" link--->
				<cfif numPages - thisPage GT 2>
					... <a href="#cgi.script_name#?st=#iif(numPages * numPerPage + 1 LTE qGetAuctionAdmin.recordCount, numPages * numPerPage + 1, (numPages - 1) * numPerPage + 1)#&nPP=#numPerPage#&view=#url.view#" title="View Last Page" style="text-decoration:underline">Last &raquo;</a> 
				</cfif>
			</td>
			<!--- display "show X per page" selection --->
			<form action="#cgi.script_name#?view=#url.view#" name="thisForm_#variables.dsp#" method="post">
