...
<b>And more!</b> Stay tuned in the weeks ahead for a mix of special offers, Limited Editions, prints and 'Buy it Now' books. <br><br> --->
	...
	<br>
		...
		<div align="left">
<iframe src="http://player.vimeo.com/video/36157888?title=0&amp;byline=0&amp;portrait=0" style="float:left;margin:5px 15px 0 15px;border:1px solid ##999" width="400" height="300" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe><a href="http://vimeo.com/36157888"><span style="font-size:18px; line-height:24px;">Robert Frank & Allen Ginsberg</span></a><br><span style="font-size:14px; line-height:20px; color:##666">
This week we're pleased to offer an amazing image of the Beat era, Robert Frank's 1959 portrait of his friend Allen Ginsberg. Four photos by Allen Ginsberg, also on offer, look back at Ginsberg's Beat lineage, forward to its mid-sixties proto-hippie incarnation, and beyond to the gazes exchanged by two <i>&eacute;minences grise</i>.  Thanks for watching!</font><br><br><!-- AddThis Button BEGIN -->
<div class="addthis_toolbox addthis_default_style " 
	addthis:url="http://vimeo.com/36157888">
...
<cfif url.View EQ "CurrentAuctions">
	...
	<cfquery name="qGetAuctionAdmin" datasource="photoeyecom">
		...
		FROM AuctionAdmin a
		WHERE (publish = 1 
		AND endannounced = 0) and (auctionid<6585) 
