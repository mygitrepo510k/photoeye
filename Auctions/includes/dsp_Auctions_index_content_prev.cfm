...
<iframe src="http://player.vimeo.com/video/47331844?title=0&amp;byline=0&amp;portrait=0" style="float:left;margin:5px 15px 0 15px;border:1px solid ##999" width="400" height="300" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe><span style="font-size:14px; line-height:20px; color:##666">  
This week, Eric looks looks at Alexey Brodovitch, presenting his incomparable Ballet (1945), along with three additional lots of Brodovitch-related material: a signed copy of his 1959 collaboration with Avedon, Observations; the Brodovitch-designed Andr&eacute; Kerté&eacute;sz gem, Day of Paris; and finally protege Mary Faulconer's moody 1934 portrait of Brodovitch and his brother-in law in the south of France. Also on the block, Michael Snow's conceptual tour de force, Cover to Cover (Hardbound edition!); Jim Cooke's brilliant Re-Placing Arcadia; a signed 1st edition of Ren&eacute; Burri's brilliant mediation on post-war German society, Die Deutschen (1st Ed.&mdash;SIGNED!) and much more! Thanks for your continued support!! <br><br>
We are now accepting consignments of fine photobooks and prints. Be sure to contact <a href="mailto:eric@photoeye.com?subject=Consignments">Eric Miles</a>  if you have material you'd like us to consider. See our auction <a href="http://www.photoeye.com/auctions/auctionFAQ.cfm">F.A.Q.s</a> for guidelines.  </font><br><!-- AddThis Button BEGIN -->
 <br><div class="addthis_toolbox addthis_default_style" 
	 addthis:url="http://vimeo.com/47331844" >
...
<!---				<cfset xImageNewAddress=ExpandPath("/auctions/img/#url.id#/")>--->
		...
		<!--- <td align="left" width="350" valign="top" style="padding-top:20px; padding-bottom:20px;"> --->
			...
			<cfif (qGetAuctionAdmin.PostAuctionSale EQ 0 AND EndAnnounced)>
			<cfif qGetAuctionAdmin.AuctionID is 6803 or qGetAuctionAdmin.AuctionID is 6798 or qGetAuctionAdmin.AuctionID is 6808 > <cfelse> #trim(mid(qGetAuctionAdmin.Description,1,50))# </cfif>  . . . <div style="margin-top:5px;"><a href="Citation.cfm?id=#qGetAuctionAdmin.auctionid#"><font color="blue" size="2">[bid or read more]</font></a> <br><br><!-- AddThis Button BEGIN -->
