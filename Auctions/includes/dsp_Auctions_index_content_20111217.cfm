...
<tr>
	...
	<cfelse>
		<br><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="##333"><b>Welcome to the new photo-eye Auctions!</b><br /><br></font>
	<div align="left">
...
<b>And more!</b> Stay tuned in the weeks ahead for a mix of special offers, Limited Editions, prints and 'Buy it Now' books. <br><br> --->
		...
		<div align="left">
<iframe src="http://player.vimeo.com/video/33809281?title=0&byline=0&portrait=0" width="400" height="300" frameborder="0" style="float:left;margin:5px 15px 0 15px;border:1px solid ##999" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe><p><a href="http://vimeo.com/33809281"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:16px; line-height:24px;" color="##666">This week's auctions focus on rare Czech books from the pre- and post-war period. Seven of these books appeared between 1938 and 1949. The subject of Eric Miles' first weekly presentation, <i>Toto mesto je vespolecne peci obyvatel (This Town is Under the Control of its Citizens)</i> was published in 1967. Thanks for watching!</font><br><br><!-- AddThis Button BEGIN -->
<div class="addthis_toolbox addthis_default_style " 
	addthis:url="http://www.photoeye.com/auctions/">
...
<cfif url.View EQ "CurrentAuctions">
	...
	<cfquery name="qGetAuctionAdmin" datasource="photoeyecom">
		...
		FROM AuctionAdmin a
		WHERE (publish = 1 
		AND endannounced = 0)    and (auctionid<6522)
...
<!---				<cfset xImageNewAddress=ExpandPath("/auctions/img/#url.id#/")>--->
		...
		<!--- <td align="left" width="350" valign="top" style="padding-top:20px; padding-bottom:20px;"> --->
			...
			<cfif (qGetAuctionAdmin.PostAuctionSale EQ 0 AND EndAnnounced)>
			#trim(mid(qGetEndedAuctions.Description,1,200))# . . . <div style="margin-top:5px;"><a href="Citation.cfm?id=#qGetAuctionAdmin.auctionid#"><font color="blue" size="2">[bid or read more]</font></a> <br><br><!-- AddThis Button BEGIN -->
<div class="addthis_toolbox addthis_default_style " 
						...
						<td align="center">
							...
							<CFIF IsDefined("photobook")>
								<cfif photobook is 1> 
									...
									<a href="/bookstore/mShowDetailsbycat.cfm?Catalog=PI146"><img src="#xImagePath#/PI146_H25xW25.jpg" width="42" height="50" alt="#xAlt#" border="1" style="border-color: #aBorderColor#; border-width: 1px; border-style: solid;"></a>
									</cfif>
...
<!---									<CFSET xreference_qty = xreference_qty+1>
							...
							<CFIF IsDefined("Book101Books")>
								...
								<!---	<cfoutput>#xImagePath#</cfoutput><cfflush>--->															
									<a href="/bookstore/mShowDetailsbycat.cfm?Catalog=PK676"><img src="#xImagePath#/PK676_H25xW25.jpg" width="42" height="50" alt="#xAlt#" border="1" style="border-color: #aBorderColor#; border-width: 1px; border-style: solid;"></a>
								</cfif>
...
<!---									<cfinclude template="/Templates/ImageSizer.cfm">--->
									<cfinclude template="/templates/CreateImageFolders.cfm">
									<a href="/bookstore/mShowDetailsbycat.cfm?Catalog=zc553"><img src="#xImagePath#/ZC553_H25xW25.jpg" width="42" height="50" alt="#xAlt#" border="1" style="border-color: #aBorderColor#; border-width: 1px; border-style: solid;"></a>							
								</cfif>
...
<!---							<cfif OpenBook is 1>
								...
								<!--- Make sure that the qty of 3 hasn't been reached --->
									...
									<cfif FotografiaPublica is 1 and  xreference_qty LTE 2>
										...
										<!---<cfinclude template="/Templates/ImageSizer.cfm">--->
										<cfinclude template="/templates/CreateImageFolders.cfm">
										<a href="/bookstore/mShowDetailsbycat.cfm?Catalog=zb448"><img src="#xImagePath#/ZB448_H25xW25.jpg" width="42" height="50" alt="#xAlt#" border="1" style="border-color: #aBorderColor#; border-width: 1px; border-style: solid;"></a>
								</cfif>							
