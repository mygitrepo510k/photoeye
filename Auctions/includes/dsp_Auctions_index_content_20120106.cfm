...
<b>And more!</b> Stay tuned in the weeks ahead for a mix of special offers, Limited Editions, prints and 'Buy it Now' books. <br><br> --->
		...
		<div align="left">
<iframe src="http://player.vimeo.com/video/34710483?title=0&byline=0&portrait=0" width="400" height="300" frameborder="0" style="float:left;margin:5px 15px 0 15px;border:1px solid ##999" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe><p><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:16px; line-height:24px;" color="##666"> In this weeks feature presentation, Eric Miles examines some of Ed Ruscha's iconic artist's books from 1962-1971. By making pictures that were cool and distant, entirely flat emotionally and lacking even a hint of personal style at a time when fine art photography was moving toward a distinctly subjective vision in documentary photography, Ruscha utterly revolutionized photographic perception. Thanks for watching!</font><br><br><!-- AddThis Button BEGIN -->
<div class="addthis_toolbox addthis_default_style " 
	addthis:url="http://vimeo.com/34710483">
