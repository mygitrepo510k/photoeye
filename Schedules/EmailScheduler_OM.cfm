...
LAST EMAIL SUCCESSFULLY SENT: 
	...
	<cfloop query="qGetEmails" startrow="#xStartrow#" endrow="#xEndrow#">
		...
		<CFIF (xEmail is not xEmailOld) and (xTesting is not 1)>
			...
			<cfmail to="#xEmail#" from="newsletter@photoeye.com" subject="Illustrated photo-eye E-News #dateformat(Now(),"mmmm d, yyyy")#" type="HTML">
		<cfinclude template="../emailnewsletter/HTMLNewsletter.cfm"></cfmail>
